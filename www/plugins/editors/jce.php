<?php
/**
 * @version		$Id: jce.php 49 2009-05-28 10:02:46Z happynoodleboy $
 * @package      JCE
...
class plgEditorJCE extends JPlugin
{
	...
	function onDisplay($name, $content, $width, $height, $col, $row, $buttons = true)
	{
	    ...
	    $editor = "<textarea id=\"$name\" name=\"$name\" cols=\"$col\" rows=\"$row\" style=\"width:{$width};\" class=\"mceEditor\">$content</textarea>\n".$buttons;
	    return $editor;
	}	

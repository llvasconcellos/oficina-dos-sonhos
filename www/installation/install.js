...
function do_UpdateParams()
{
	...
	var myDrop = document.getElementById("drop").checked == true ? 1 : 0;
	var myBackup = document.getElementById("backup").checked == true ? 1 : 0;
	var mySkipNonJ = document.getElementById("skipnonj").checked == true ? 1 : 0;

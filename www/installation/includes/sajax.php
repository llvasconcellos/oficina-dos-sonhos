...
*
* Simple AJAX library [ this library is called (S)AJAX and is copyrighted by ModernMethod ]
*
					...
					if (status == "") {
						...
						if (target_id != "")
							...
							try {
								...
								alert("Caught AJAX error " + e + ": Could not eval " + data );

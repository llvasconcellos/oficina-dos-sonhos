...
<div align="center" style="margin:0;padding:0;margin-top:10px;">
	<div id="phoca_geo_map" style="margin:0;padding:0;width:<?php echo $this->tmpl['largemapwidth'];?>px;height:<?php echo $this->tmpl['largemapheight'];?>px"></div>
</div>
...
function getPhocaGeoMap(){
	if (tst_phoca_geo.offsetWidth > 0) {
		...
		GEvent.addListener(marker_phoca_geo, 'click', function() {
			marker_phoca_geo.openInfoWindowHtml('<?php echo $text;?>');
			});

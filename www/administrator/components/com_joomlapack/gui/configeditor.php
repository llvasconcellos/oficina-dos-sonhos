	...
	function echoHTML()
	{
		...
		?>
			<table cellpadding="4" cellspacing="0" border="0" width="95%" class="adminform">	
				...
				<tr>
					<td>&nbsp;</td>
					<td><?php echo JoomlapackLangManager::_('CONFIG_MYSQLKEEPALIVE'); ?></td>
					<td><input name="enableMySQLKeepalive" type="checkbox" <?php echo ($configuration->get("enableMySQLKeepalive") ) ? 'checked' : ''; ?> /></td>
				</tr>
			</table>	
		<?php
			$tabs->endTab();

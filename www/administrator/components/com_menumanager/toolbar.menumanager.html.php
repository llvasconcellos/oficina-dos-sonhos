...
class TOOLBAR_menumanager {
	...
	*/
	function _DEFAULT() {
		...
		mosMenuBar::customX( 'copyconfirm', 'copy.png', 'copy_f2.png', 'Copiar', true );
		mosMenuBar::spacer();
		mosMenuBar::customX( 'deleteconfirm', 'delete.png', 'delete_f2.png', 'Deletar', true );
		mosMenuBar::spacer();
...
/*		mosMenuBar::help( 'screen.menumanager' );*/
	...
	*/
	function _NEWMENU()	{
		mosMenuBar::startTable();
		mosMenuBar::custom( 'savemenu', 'save.png', 'save_f2.png', 'Salvar', false );
		mosMenuBar::spacer();
		mosMenuBar::cancel();
		mosMenuBar::spacer();
/*		mosMenuBar::help( 'screen.menumanager.new' );*/
	...
	*/
	function _COPYMENU()	{
		mosMenuBar::startTable();
		mosMenuBar::custom( 'copymenu', 'copy.png', 'copy_f2.png', 'Copiar', false );
		mosMenuBar::spacer();
		mosMenuBar::cancel();
		mosMenuBar::spacer();

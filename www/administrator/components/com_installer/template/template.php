...
HTML_installer::showInstallForm( 'Instalar temas  <small><small>[ ' . ($client == 'admin' ? 'Administração' : 'Site') .' ]</small></small>',
	$option, 'template', $client, $userfile,
	'<a href="index2.php?option=com_templates&client='.$client.'">Voltar ao administador de temas</a>'
);
?>
<table class="content">
<?php

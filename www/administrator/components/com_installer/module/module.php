...
HTML_installer::showInstallForm( 'Enviar novo módulo', $option, 'module', '', dirname(__FILE__) );
?>
<table class="content">
<?php
writableCell( 'media' );
...
function showInstalledModules( $_option ) {
	...
	$select[] 		= mosHTML::makeOption( '', 'Todos' );
	$select[] 		= mosHTML::makeOption( '0', 'Módulos do Site' );
	$select[] 		= mosHTML::makeOption( '1', 'Módulos da Administração' );

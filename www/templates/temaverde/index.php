...
<?php mosShowHead(); ?>
<link rel="stylesheet" type="text/css" href="<?php echo $mosConfig_live_site; ?>/templates/temaverde/css/template_css.css" />
</head>
<body>
...
<tr>
	...
	<img src="<?php echo $mosConfig_live_site; ?>/templates/temaverde/images/pixel.png" width="1" height="1" alt="spacer" />
	</td>
	<td valign="top" class="greybg">
		...
		<tr>
			...
			<img src="<?php echo $mosConfig_live_site; ?>/templates/temaverde/images/image_01.jpg" width="790" height="201" alt="header" />
			</td>
		</tr>
		</table>

...
//	Updated to 2.0.5 by Waheed Al-Sayer (waheed@shamayel.com)
//
...
$lang['Already_voted'] = 'áŞÏ Êã ÊÓÌíá ÕæÊß ãÓÈŞÇ İí åĞÇ ÇáÇÓÊİÊÇÁ.';
$lang['No_vote_option'] = 'íÌÈ Çä ÊŞÑÑ ÇÎÊíÇÑ ŞÈá Çä ÊÕæÈ';
...
$lang['Unread_message'] = 'ÑÓÇáÉ áã ÊŞÑÃ';
$lang['Read_message'] = 'ÑÓÇáÉ ãŞÑæÃÉ';

$lang['Read_pm'] = 'ÑÓÇáÉ ãŞÑæÃÉ';
$lang['Post_new_pm'] = 'ÇÑÓá ÑÓÇáÉ';
$lang['Post_reply_pm'] = 'ÑÏ Úáì ÇáÑÓÇáÉ';
$lang['Post_quote_pm'] = 'ÇŞÊÈÓ ãä ÇáÑÓÇáÉ';
...
$lang['Too_many_registers'] = 'áŞÏ ÇßËÑÊ ãä ãÍÇæáÇÊ ÇáÊÓÌíá. ÇáÑÌÇÁ ÇáãÍÇæáÉ İí æŞÊ áÇÍŞ.';
...
$lang['Already_activated'] = 'áŞÏ İÚáÊ ÍÓÇÈß ãÓÈŞÇ';
...
//
$lang['Confirm_code_wrong'] = 'ÑãÒ ÇáÊÃßíÏ ÇáĞí ÇÏÎáÊå ÛíÑ ÕÍíÍ';
$lang['Too_many_registers'] = 'áŞÏ ÊÌÇæÒÊ ãÍÇæáÇÊ ÇáÊÓÌíá İí åĞå ÇáÌáÓÉ. ÇáÑÌÇÁ ÇáãÍÇæáÉ İí æŞÊ áÇÍŞ.';
$lang['Confirm_code_impaired'] = 'Çä ßÇäÊ áÏíß ÕÚæÈÉ İí ŞÑÇÁÉ ÇáÑãÒ ÇáÑÌÇÁ ãÎØÇÈÉ  %sAdministrator%s ááãÓÇÚÏÉ.';
$lang['Confirm_code'] = 'ÑãÒ ÇáÊÃßíÏ';
$lang['Confirm_code_explain'] = 'ÇÏÎá ÇáÑãÒ ÊãÇãÇ ßãÇ ÊÑÇå. ÇáÑãÒ Èå ÍÑæİ ÇäÌáíÒíÉ ßÈíÑÉ æÕÛíÑÉ¡ æÇáÕİÑ Úáíå ÎØ ÈÒÇæíÉ.';
...
$lang['datetime']['November'] = 'äæİãÈÑ';
$lang['datetime']['December'] = 'ÏíÓãÈÑ';
$lang['datetime']['Jan'] = 'íäÇíÑ';
$lang['datetime']['Feb'] = 'İÈÑÇíÑ';

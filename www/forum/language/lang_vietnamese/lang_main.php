...
$lang['View_next_topic'] = 'Xem chủ đề mới hơn';
$lang['View_previous_topic'] = 'Xem chủ đề cũ hơn';
...
$lang['Smilies_are_ON'] = 'Hình vui đang <u>Mở</u>';
$lang['Smilies_are_OFF'] = 'Hình vui đang <u>Tắt</u>';
...
$lang['Profile_info_warn'] = 'Các thông tin này sẽ được công bố cho mọi người biết';
...
$lang['Agree_under_13'] = 'Tôi đồng ý với những quy định trên và tôi <b>dưới</b> 13 tuổi';
$lang['Agree_over_13'] = 'Tôi đồng ý với những quy định trên và tôi <b>trên</b> hoặc <b>đúng</b> 13 tuổi';
...
$lang['Search_Flood_Error'] = 'Bạn không thể tìm kiếm liên tục như vậy. Hãy chờ khoảng 30 giây giữa 2 lần tìm kiếm.';
...
$lang['A_critical_error'] = '1 Lỗi nghiêm trọng đã xảy ra';

$lang['Admin_reauthenticate'] = 'Để quản lý diễn đàn bạn phải xác nhận lại tài khoản của mình.';
$lang['Login_attempts_exceeded'] = 'Số lần đăng nhập %s đã hết. Bạn không được phép đăng nhập diễn đàn này trong vòng %s phút.';
$lang['Please_remove_install_contrib'] = 'Hãy chắc rằng bạn đã xoá 2 thư mục install/ và contrib/ sau khi cài đặt, nếu không bạn không thể truy cập diễn đàn.';

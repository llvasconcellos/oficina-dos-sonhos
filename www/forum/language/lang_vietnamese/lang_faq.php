...
$faq[] = array("Tôi đã đăng ký, nhưng không thể đăng nhập!", "Đầu tiên bạn phải chắc rằng đã nhập đúng tên và mật khẩu. Nếu bạn đã nhập đúng thì có thể xảy ra 2 vấn đề: nếu hỗ trợ COPPA là hiệu lực và bạn nhấn vào nút liên kết <u>Tôi dưới 13 tuổi</u> lúc đăng ký thì bạn phải làm theo hướng dẫn mà bạn đã nhận qua email-fax. Nếu đây không phải là nguyên nhân thì có lẽ bạn cần kích hoạt tài khoản. Một vài diễn đàn yêu cầu tất cả thành viên mới đăng ký phải kích hoạt tài khoản bằng cách tự kích hoạt hoặc bởi người điều hành trước khi bạn có thể đăng nhập. Khi bạn đăng ký xong diễn đàn có thông báo yêu cầu bạn kích hoạt tài khoản. Nếu bạn đã gửi email theo hướng dẫn; nếu bạn không nhận được email thì cần kiểm tra lại địa chỉ email của bạn xem có đúng chưa. Lý do yêu cầu kích hoạt là nhằm giảm thiểu nguy cơ <i>gia nhập giả danh</i> vào diễn đàn bằng tên giả danh. Nếu bạn chắc rằng đã dùng email đúng, thì cần liên hệ với người quản lý diễn đàn .");
$faq[] = array("Tôi đã đăng ký trước đây, nhưng không thể đăng nhập được nữa!", "Hầu hết các trường hợp là: bạn nhập vào tên và mật khẩu không chính xác (kiểm tra thư đầu tiên mà diễn đàn đã gửi cho bạn lúc đăng ký) hoặc bạn đã không đăng nhập vào diễn đàn khá lâu, vì vậy người điều hành đã xoá tài khoản của bạn. Nếu bạn đã khá lâu không gửi bài trong diễn đàn có lẽ tên của bạn đã bị xoá. Trong trường hợp này bạn cần đăng ký lại.");
...
$faq[] = array("Làm thế nào tôi có thể đổi cấp bậc của mình?", "Bạn không được phép trực tiếp đổi cấp bậc (cấp bậc hiện ngay dưới tên trong khi xem chủ đề và trong trang thông tin cá nhân của bạn tuỳ thuộc vào giao diện của diễn đàn). Hầu hết các diễn đàn dùng cấp bậc để phân loại theo số bài thành viên đã gửi trong diễn đàn. Ví dụ, người điều hành và người quản trị có cấp bậc đặc biệt. Xin đừng gửi bài vô ích nhằm được tăng cấp bậc -- lẽ đôi khi bạn cũng nhìn thấy người điều hành và người quản trị có số bài ít hơn các thành viên khác trong diễn đàn.");
$faq[] = array("Tôi có thể gửi Email trực tiếp từ Diễn Đàn không?", "Nếu Người Điều Hành Diễn Đàn cho hiệu lực chức năng này, các thành viên có thể gửi email theo dạng thức Plant text cho nhau trực tiếp từ trong Diễn đàn mà không cần sử dụng tới chương trình Email nào khác. Bạn chỉ cần bấm chuột vào nút <i>Gởi email cho người nầy</i> (thường xuất hiện khi đọc thư hay khi xem lý lịch của thành viên) rồi nhập nội dung thư.");

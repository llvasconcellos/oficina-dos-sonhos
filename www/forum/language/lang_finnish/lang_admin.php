 ...
 *
 *     $Id: lang_admin.php,v 1.5.2.2 2002/05/17 13:57:52 psotfx Exp $
 *
 ****************************************************************************/
...
//	http://www.pitro.com/
//
//	Translation updated by Martti Lokka (Lurttinen)
//	http://www.kriisipiste.com
//
...
// Visual Confirmation
$lang['Visual_confirm'] = 'Aktivoi visuaalinen varmennus';
$lang['Visual_confirm_explain'] = 'Käyttäjän on rekisteröityessä annettava koodi, jonka hän saa ruudulla olevasta kuvasta.';

// Autologin Keys - added 2.0.18
$lang['Allow_autologin'] = 'Salli automaattiset kirjautumiset';
$lang['Allow_autologin_explain'] = 'Määrittelee annetaanko käyttäjien valita automaattinen kirjautuminen foorumile tultaessa.';
$lang['Autologin_time'] = 'Automaattinen kirjautuminen kuoleentuu';
$lang['Autologin_time_explain'] = 'Määrittelee, kuinka monta päivää automaattinen kirjautuminen on voimassa, jos käyttäjä ei vieraile foorumilla. Aseta arvoksi nolla poistaaksesi toiminnon käytöstä';

// Search Flood Control - added 2.0.20
$lang['Search_Flood_Interval'] = 'Haku-toiminnon aikaraja';
$lang['Search_Flood_Interval_explain'] = 'Määrittelee, kuinka monta sekunttia käyttäjän on odotettava hakujensa välillä'; 
...
$lang['Confirm_delete_smiley'] = 'Haluatko varmasti poistaa tämän hymiön?';
...
$lang['Confirm_delete_word'] = 'Haluatko varmasti poistaa tämän sanan sensuroinnin?';
...
$lang['Confirm_delete_rank'] = 'Haluatko varmasti poistaa tämän tittelin?';
...
$lang['Stylesheet_explain'] = 'CSS tiedoston nimi käytettäväksi tälle tyylille.';
...
// Version Check
//
$lang['Version_up_to_date'] = 'Käytössäsi oleva versio on ajan tasalla, uudempia phpBB-päivityksiä ei tällä hetkellä ole saatavilla.';
$lang['Version_not_up_to_date'] = 'Käytössäsi oleva versio <b>ei</b> ole ajan tasalla. Saat uusimman phpBB-päivityksen osoitteesta <a href="http://www.phpbb.com/downloads.php" target="_new">http://www.phpbb.com/downloads.php</a> to obtain the latest version.';
$lang['Latest_version_info'] = 'Viimeisin saatavilla oleva versio on <b>phpBB %s</b>.';
$lang['Current_version_info'] = 'You are running <b>phpBB %s</b>.';
$lang['Connect_socket_error'] = 'Yhteyden muodostaminen phpBB-palvelimeen epäonnistui, virheilmoitus on:<br />%s';
$lang['Socket_functions_disabled'] = 'Socket-toimintojen käyttö ei onnistu.';
$lang['Mailing_list_subscribe_reminder'] = 'Saadaksesi aina ajankohtaisimmat tiedot phpBB:stä, <a href="http://www.phpbb.com/support/" target="_new">liity postituslistallemme</a>.';
$lang['Version_information'] = 'Versiotiedot';

//
// Login attempts configuration
//
$lang['Max_login_attempts'] = 'Sallittu määrä kirjautumisyrityksiä';
$lang['Max_login_attempts_explain'] = 'Määrittelee, kuinka monta kertaa käyttäjän annetaan yrittää kirjautumista.';
$lang['Login_reset_time'] = 'Kirjautumisen lukitseminen';
$lang['Login_reset_time_explain'] = 'Määrittelee, kuinka kauan käyttäjän on odotettava ennen seuraavaa kirjautumisyritystä';

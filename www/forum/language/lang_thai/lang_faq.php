 ...
 *
 *   Translation: SuperToy < SuperToy_nc@yahoo.com >
 *
...
$faq[] = array("ทำไมเข้าสู่ระบบไม่ได้?", " &nbsp; 1.คุณได้ทำการสมัครสมาชิกแล้วหรือยัง? คุณต้องสมัครสมาชิกก่อน แล้วจึงสามารถเข้าสู่ระบบได้.<br /> &nbsp; 2.คุณถูกหวงห้ามไม่ให้เข้าสู่บอร์ดหรือไม่(จะมีข้อความบอกไว้)? ถ้าเป็นเช่นนั้น คุณควรติดต่อ webmaster หรือ administrator ของบอร์ด เพื่อขอทราบเหตุผล.<br /> &nbsp; 3.ถ้าคุณได้ทำการสมัครสมาชิกแล้ว และไม่ได้ถูกหวงห้าม และคุณยังไม่สามารถเข้าสู่ระบบได้ กรุณาตรวจสอบ username และ password ให้ถูกต้อง.<br /> &nbsp; 4.ถ้าคุณใช้ Internet Explorer อยู่ บางทีระบบ Cookie อาจมีปัญหา ให้คุณทำตามนี้<br /> &nbsp; &nbsp; 4-1. ปิดโปรแกรม Internet Explorer ให้หมด<br /> &nbsp; &nbsp; 4-2. คลิกขวาที่ไอคอน Internet Explorer (รูปตัว e สีฟ้าบนเดสก์ท็อป) เลือกคำสั่ง Properties<br /> &nbsp; &nbsp; 4-3. คลิกปุ่ม Delete Cookies-&gt;OK<br /> &nbsp; &nbsp; 4-4. คลิกปุ่ม Delete Files กาถูกหน้า Delete all ...-&gt;OK<br /> &nbsp; &nbsp; 4-5. คลิกปุ่ม Clear History-&gt;Yes<br /> &nbsp; &nbsp; 4-6. คลิกปุ่ม OK<br /> &nbsp; &nbsp; 4-7. เปิดโปรแกรม Internet Explorer ขึ้นมาทดลอง log in ดูใหม่อีกรอบ<br /> &nbsp; 5.ถ้ายังเข้าสู่ระบบไม่ได้อีก กรุณาติดต่อ administrator ของบอร์ด ว่าอาจมีการตั้งค่าที่ไม่ถูกต้องเกิดขึ้นในบอร์ด.");
...
$faq[] = array("จะสร้างหัวข้อใหม่ได้อย่างไร?", " &nbsp; คลิกที่ปุ่มสร้างหัวข้อใหม่ ใน forum หรือในหัวข้อ (คุณอาจต้องสมัครสมาชิกก่อน จึงจะสามารถโพสต์ข้อความได้). คุณจะเห็นข้อความบอกว่าคุณสามารถสร้างหัวข้อใหม่ได้หรือไม่ ที่ด้านล่างของหน้าใน forum หรือในหัวข้อ (เช่น <i>คุณสามารถสร้างหัวข้อใหม่, คุณสามารถลงคะแนน, ฯลฯ.</i>)");

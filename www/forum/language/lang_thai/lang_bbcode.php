...
$faq[] = array("--", "อื่นๆ");
$faq[] = array("จะใส่คำสั่งของตัวเองได้หรือไม่?", "สำหรับ phpBB 2.0 คุณจะยังไม่สามารถใส่คำสั่งของตัวเองลงไปได้ แต่อาจจะมีการใส่คำสั่ง BBCode ส่วนตัวได้ใน phpBB รุ่นต่อไป");

...
$lang['bbcode_b_help'] = 'ทำตัวหนา: [b]ข้อความตัวหนา[/b]  (alt+b)';
$lang['bbcode_i_help'] = 'ทำตัวเอียง: [i]ข้อความตัวเอียง[/i]  (alt+i)';
$lang['bbcode_u_help'] = 'ขีดเส้นใต้: [u]ข้อความขีดเส้นใต้[/u]  (alt+u)';
$lang['bbcode_q_help'] = 'อ้างอิงข้อความ: [quote]ข้อความที่ถูกอ้างอิง[/quote]  (alt+q)';
$lang['bbcode_c_help'] = 'Code: [code]ข้อความแบบ Code[/code]  (alt+c)';
$lang['bbcode_l_help'] = 'รายการ: [list]ข้อความแบบรายการ[/list]  (alt+l)';
$lang['bbcode_o_help'] = 'ลำดับรายการ: [list=]ข้อความแบบลำดับรายการ[/list]  (alt+o)';
$lang['bbcode_p_help'] = 'แทรกรูปภาพ: [img]http://image_url[/img]  (alt+p)';
$lang['bbcode_w_help'] = 'แทรก URL: [url]http://url[/url] หรือ [url=http://url]ข้อความแสดง[/url]  (alt+w)';
$lang['bbcode_a_help'] = 'พยายามปิดท้ายทุกคำสั่ง BBCode ให้โดยอัตโนมัติ (ยกเว้นการทำสีและขนาดตัวอักษร)';
$lang['bbcode_s_help'] = 'ทำสีตัวอักษร: [color=red]ข้อความสีแดง[/color] หรือจะใช้ color=#FF0000 ก็ได้';
$lang['bbcode_f_help'] = 'กำหนดขนาดตัวอักษร: [size=x-small]ข้อความที่จะกำหนดขนาด[/size]';
...
$lang['Account_added'] = 'ขอบคุณที่สมัครสมาชิก บัญชีของคุณถูกสร้างแล้ว คุณสามารถเข้าสู่ระบบได้ด้วย username และ password ที่คุณสมัคร';
$lang['Account_inactive'] = 'ขอบคุณที่สมัครสมาชิก บัญชีของคุณถูกสร้างแล้ว แต่คุณต้องทำการยืนยันก่อน กรุณากลับไปเช็ค Email ที่คุณใช้สมัคร';
$lang['Account_inactive_admin'] = 'ขอบคุณที่สมัครสมาชิก บัญชีของคุณถูกสร้างแล้ว คุณจะได้รับ Email แจ้ง เมื่อ Admin ได้อนุญาตแล้ว';
$lang['Account_active'] = 'บัญชีของคุณได้ถูกยืนยันแล้ว ขอบคุณที่สมัครสมาชิก';
...
$lang['Search_Flood_Error'] = 'กรุณารอสักครู่ ก่อนจะทำการค้นหาครั้งใหม่ได้';
...
$lang['Sorry_auth_edit'] = 'ขออภัย. เฉพาะ %s เท่านั้น ที่สามารถแก้ไขข้อความใน forum นี้'; 
$lang['Sorry_auth_delete'] = 'ขออภัย. เฉพาะ %s เท่านั้น ที่สามารถลบข้อความใน forum นี้'; 
$lang['Sorry_auth_vote'] = 'ขออภัย. เฉพาะ %s เท่านั้น ที่สามารถลงคะแนนแบบสำรวจใน forum นี้'; 

// These replace the %s in the above strings
$lang['Auth_Anonymous_Users'] = '<b>ผู้ใช้ที่ไม่ระบุนาม</b>';
...
$lang['Online_explain'] = 'นับเฉพาะสมาชิกที่ล็อกอินมากกว่า 5 นาทีขึ้นไป';

$lang['Forum_Location'] = 'ตำแหน่ง forum';
$lang['Last_updated'] = 'ทำงานล่าสุด';

$lang['Forum_index'] = 'รายการ forum';
$lang['Logging_on'] = 'กำลังเข้าสู่ระบบ';
$lang['Posting_message'] = 'กำลังตอบข้อความ';
...
$lang['Leave_shadow_topic'] = 'ทิ้งข้อความบอกไว้ใน forum เดิมด้วย';

$lang['Split_Topic'] = 'เครื่องมือสำหรับแยกหัวข้อ';
$lang['Split_Topic_explain'] = 'แบบฟอร์มด้านล่างใช้สำหรับแยกหัวข้อออกเป็น 2 ส่วน, โดยการเลือกทีละข้อความหรือหลายข้อความก็ได้';
$lang['Split_title'] = 'ชื่อหัวข้อใหม่';
$lang['Split_forum'] = 'Forum สำหรับหัวข้อใหม่';
$lang['Split_posts'] = 'แยกออกไปเฉพาะข้อความที่เลือก';
$lang['Split_after'] = 'แยกตั้งแต่ข้อความที่เลือกเป็นต้นไป';
$lang['Topic_split'] = 'แยกหัวข้อที่ถูกเลือกเรียบร้อยแล้ว';

$lang['Too_many_error'] = 'คุณเลือกข้อความมากเกินไป. คุณต้องเลือกเฉพาะข้อความจุดเริ่มต้นที่จะแยกเท่านั้น!';
...
$lang['Other_IP_this_user'] = 'หมายเลข IP อื่นๆของผู้ตอบ';
$lang['Users_this_IP'] = 'ตอบจากหมายเลข IP';
$lang['IP_info'] = 'ข้อมูลของหมายเลข IP';
$lang['Lookup_IP'] = 'ดูรายละเอียดของหมายเลข IP';
...
$lang['Critical_Information'] = 'รายละเอียของความผิดพลาด';

$lang['General_Error'] = 'ความผิดพลาดทั่วไป';
$lang['Critical_Error'] = 'ความผิดพลาดร้ายแรง';
$lang['An_error_occured'] = 'เกิดความผิดพลาด';
$lang['A_critical_error'] = 'เกิดความผิดพลาดร้ายแรง';

$lang['Admin_reauthenticate'] = 'คุณจะต้องทำการยืนยันชื่อของคุณอีกครั้ง เพื่อที่จะสามารถจัดการกับบอร์ดนี้ได้';
$lang['Login_attempts_exceeded'] = 'คุณพยายามล็อกอินมาแล้ว %s ครั้ง. คุณจะต้องรออีก %s นาที จึงจะล็อกอินได้ใหม่อีกครั้ง';
$lang['Please_remove_install_contrib'] = 'โปรดลบไดเร็คทอรี install/ และ contrib/ ทิ้งด้วย';

...
// please add it here.
$lang['TRANSLATION_INFO'] = 'Türkçe Çeviri: <a href="http://www.phpbbturkey.com" target="_blank" class="copyright">phpBB Turkey</a> & <a href="http://www.turkiyeforum.com" target="_blank" class="copyright">Türkiye Forum</a>';
...
$lang['Record_online_users'] = 'Sitede bugüne kadar en çok <b>%s</b> kiþi %s tarihinde çevrimiçi oldu.'; // first %s = number of users, second %s is the date.
...
$lang['Forum_locked'] = 'Bu forum kilitlenmiþtir: mesaj gönderemez, cevap yazamaz, ya da baþlýklarý deðiþtiremezsiniz';
...
$lang['Topic_reply_notification'] = 'Baþlýk - Cevap Ýzleme';
...
$lang['Emoticons'] = 'Ýfade Paneli';
$lang['More_emoticons'] = 'Tüm ifadeleri göster';
...
$lang['Cannot_send_privmsg'] = 'Üzgünüz, site yöneticisi sizin özel mesaj gönderme hakkýnýzý iptal etmiþtir';
...
$lang['No_send_account_inactive'] = 'Þu anda þifreniz belirlenemiyor çünkü hesabýnýz aktif deðil. Lütfen site yöneticisi ile görüþünüz';
...
$lang['Always_notify_explain'] = 'Sizin gönderdiðiniz biz baþlýða her cevap geldiðinde sizi e-posta ile haberdar eder. Bu her mesaj gönderiþinizde de deðiþtirilebilir.';
...
$lang['Hide_user'] = 'Çevrimiçi olduðumu gizle';

$lang['Profile_updated'] = 'Profiliniz güncellendi';
$lang['Profile_updated_inactive'] = 'Profiliniz güncellendi, ama bazý önemli bilgileri deðiþtirdiðiniz için hesabýnýz aktif deðil. Yeniden aktif hale getirmek için yapmanýz gerekenleri bulmak için e-posta\'nýzý kontrol edin, eðer yönetici onayý gerekiyorsa, site yöneticisinin onaylamasýný bekleyin';
...
$lang['Email_taken'] = 'Üzgünüz bu e-posta adresi baþka bir kullanýcý tarafýndan kullanýlýyor';
$lang['Email_banned'] = 'Üzgünüz bu e-posta adresi yasaklanmýþ';
$lang['Email_invalid'] = 'Üzgünüz bu e-posta adresi doðru deðil';
...
$lang['Account_added'] = 'Kaydolduðunuz için teþekkürler, hesabýnýz yaratýlmýþtýr. Kullanýcý isminiz ve þifrenizle giriþ yapabilirsiniz';
$lang['Account_inactive'] = 'Hesabýnýz yaratýlmýþtýr. Aktivasyon kodu e-posta adresinize gönderilmiþtir. Daha fazla bilgi için e-posta kutunuzu kontrol edin';
$lang['Account_inactive_admin'] = 'Hesabýnýz yaratýlmýþtýr. Ama hesabýnýzýn aktif hale gelmesi için yönetici onayý gerekmektedir. Onlara bir e-posta gönderilmiþtir ve hesabýnýz aktif hale geldiðinde size haber verilecektir';
...
$lang['Password_updated'] = 'Yeni þifreniz yaratýldý, nasýl aktif hale getireceðinizi öðrenmek için e-posta adresinizi kontrol edin';
...
$lang['Password_activated'] = 'Hesabýnýz yeniden aktif hale getirilmiþtir. Giriþ yapmak için e-posta adresinize gönderilen þifreyi kullanýn';

$lang['Send_email_msg'] = 'E-posta gönder';
$lang['No_user_specified'] = 'Kullanýcý ismi seçilmedi';
$lang['User_prevent_email'] = 'Bu kullanýcý e-posta almak istemiyor. Özel Mesaj göndermeyi deneyin';
...
$lang['Flood_email_limit'] = 'Þu anda baþka bir e-posta gönderemezsiniz, lütfen daha sonra tekrar deneyiniz';
$lang['Recipient'] = 'Alýcý';
$lang['Email_sent'] = 'E-posta gönderilmiþtir';
$lang['Send_email'] = 'E-posta\'yý gönder';
...
$lang['Group_joined'] = 'Bu gruba baþarýyla kaydoldunuz<br />Üyeliðiniz moderatör tarafýndan onaylandýðýna haberdar edileceksiniz';
...
$lang['Not_group_moderator'] = 'Bu grubun moderatöru deðilsiniz, bunu yapamazsýnýz.';
...
$lang['You_been_banned'] = 'Bu forumdan yasaklandýnýz<br />Ayrýntýlý bilgi için webmaster ya da forum yöneticisi ile baðlantýya geçin';
...
$lang['Admin_reauthenticate'] = 'Yönetim paneline girebilmek için lütfen kullanýcý adý ve þifrenizi tekrar girin.';

$lang['Login_attempts_exceeded'] = 'Hesabýnýza en fazla %s kere hatalý giriþ denemesi yapabilirsiniz. %s dakika süreyle hesabýnýz kilitlendi, lütfen daha sonra tekrar deneyin.'; 
$lang['Please_remove_install_contrib'] = 'Lütfen install/ ve contrib/ klasörlerini silin';

$lang['Search_Flood_Error'] = 'Son aramanýzdan belirli bir süre geçmedikten sonra yeni bir arama yapamazsýnýz, lütfen kýsa bir süre bekleyerek yeniden deneyin.';

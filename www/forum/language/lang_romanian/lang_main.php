...
$lang['TRANSLATION_INFO'] = 'Varianta în limba românã: <a href="http://www.phpbb.ro" target="_blank">Romanian phpBB online community</a>';
...
$lang['Hidden_user_total'] = '%d Ascuns ºi ';
...
$lang['Flood_Error'] = 'Nu puteþi sã trimiteþi un mesaj nou la un interval atât de scurt dupa anteriorul; vã rugãm, încercaþi mai târziu.';
...
$lang['You_new_pm'] = 'Un mesaj nou privat aºteaptã în cutia cu mesaje';
$lang['You_new_pms'] = 'Mai multe mesaje noi aºteaptã în cutia cu mesaje';
$lang['You_no_new_pm'] = 'Nu sunt mesaje noi în aºteptare în cutia cu mesaje';
...
$lang['No_messages_folder'] = 'Nu aveþi mesaje noi în acestã cutie pentru mesaje';
...
$lang['Click_return_inbox'] = "Apãsaþi %saici%s pentru a reveni la cutia cu mesaje";
...
$lang['Inbox_size'] = "Cutia dumneavoastrã cu mesaje este %d%% plinã"; // eg. Your Inbox is 50% full
$lang['Sentbox_size'] = "Cutia dumneavoastrã cu mesaje trimise este %d%% plinã";
$lang['Savebox_size'] = "Cutia dumneavoastrã cu mesaje salvate este %d%% plinã";

$lang['Click_view_privmsg'] = "Apãsaþi %saici%s pentru a ajunge la cutia dumneavoastrã cu mesaje";
...
$lang['Avatar_filetype'] = 'Imaginile asociate trebuie sã fie de tipul: .jpg, .gif sau .png';
...
$lang['Too_many_registers'] = 'Aþi depãºit numãrul de înregistrãri setat pentru aceastã sesiune. Vã rugãm încercaþi mai tarziu.';
...
$lang['Pending_members'] = 'Membri în aºteptare';
...
$lang['Memberships_pending'] = 'Membri în aºteptare';
...
$lang['No_pending_group_members'] = 'Acest grup nu are membri în aºteptare';
...
$lang['This_closed_group'] = 'Acesta este un grup închis, nu mai acceptã noi membri';
...
$lang['Search_Flood_Error'] = 'Nu poþi face altã cãutare atât de recentã faþã de ultima; te rog încearcã din nou în câteva clipe.';
...
$lang['Sorry_auth_announce'] = 'Ne pare rãu dar doar cei care sunt %s pot pune anunþuri în acest forum';
$lang['Sorry_auth_sticky'] = 'Ne pare rãu dar doar cei care sunt %s pot pune mesaje importante în acest forum';
$lang['Sorry_auth_read'] = 'Ne pare rãu dar doar cei care sunt %s pot citi subiectele din acest forum';
$lang['Sorry_auth_post'] = 'Ne pare rãu dar doar cei care sunt %s pot scrie subiecte în acest forum';
$lang['Sorry_auth_reply'] = 'Ne pare rãu dar doar cei care sunt %s pot rãspunde în acest forum';
$lang['Sorry_auth_edit'] = 'Ne pare rãu dar doar cei care sunt %s pot modifica un mesaj în acest forum';
$lang['Sorry_auth_delete'] = 'Ne pare rãu dar doar cei care sunt %s pot sterge un mesaj din acest forum';
$lang['Sorry_auth_vote'] = 'Ne pare rãu dar doar cei care sunt %s pot vota în chestionarele din acest forum';
...
$lang['Reg_user_online'] = 'Este %d utilizator înregistrat ºi '; // There ae 5 Registered and
...
$lang['Login_attempts_exceeded'] = 'Numãrul maxim de încercãri permise de autentificare a fost depãºit. Nu vei mai avea voie sã te autentifici în urmãtoarele %s minute.';

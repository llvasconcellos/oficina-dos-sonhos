...
$lang['Backup_options'] = 'Opþiunile de salvare (backup)';
$lang['Start_backup'] = 'Porneºte operaþiunea de salvare (backup)';
...
$lang['Backups_not_supported'] = 'Scuzaþi, dar efectuarea salvãrii (backup-ului) nu este în prezent realizabilã pentru sistemul dumneavoastrã de baze de date';
...
$lang['Use_SMTP'] = 'Folosiþi serverul SMTP pentru email';
...
$lang['Confirm_delete_word'] = 'Sunteþi sigur cã doriþi sã ºtergeþi acest acest cuvânt cenzurat ?';
...
// Install Process
//
$lang['Welcome_install'] = 'Bine aþi venit la procedura de instalare a forumului phpBB2';

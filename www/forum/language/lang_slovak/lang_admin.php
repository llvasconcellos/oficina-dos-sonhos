 ...
 *
 *     $Id: lang_admin.php,v 1.0.0.0 2006/01/01 00:00:01 JanoF Exp $
 *
 ***************************************************************************/
...
$lang['Mass_Email'] = 'Hromadnı email';
...
$lang['Backup_explain'] = 'Táto funkcia je urèená na kompletnú zálohu dát phpBB fóra. Ak pouívate niektoré ïalšie tabu¾ky spoloène s phpBB databázou, doporuèujeme ich tie zálohova, zadajte preto prosím názvy tabuliek a odde¾te ich odde¾ovaèom (,). Ak to Váš server podporuje, môete poui GZIP kompresiu dát pre zmenšenie ve¾kosti súborov pred ich stiahnutím do Vášho poèítaèa.';
...
$lang['Backups_not_supported'] = '¼utujem, ale zálohovanie databázy nie je v súèasnej dobe vo Vašom databázovom systéme podporované.';

$lang['Restore_Error_uploading'] = 'Vyskytla sa chyba pri nahrávaní zálohy.';
...
$lang['Group_auth_explain'] = 'Tu môete meni oprávnenia a priradi moderovanie skupine uívate¾ov. Nezabudnite, e individuálne oprávnenie uívate¾a môe stále dovolova uívate¾ovi akcie, ktoré ste skupine zakázali (vstup uívate¾a do fóra a pod.). Pokia¾ tento prípad nastane, budete varovanı.';
$lang['User_auth_explain'] = 'Tu môete meni oprávnenia a priradi moderovanie zvolenému uívate¾ovi. Nezabudnite, e oprávnenia skupiny môu stále dovolova uívate¾ovi akcie, ktoré ste uívate¾ovi zakázali (vstup uívate¾a do fóra a pod.). Pokia¾ tento prípad nastane, budete varovanı.';
...
$lang['Conflict_access_userauth'] = 'Tento uívate¾ má poadované prístupové práva k tomuto fóru cez èlenstvo v skupine. Môete povoli oprávnenie skupine, alebo odstráni tohto uívate¾a zo skupiny pre úplné zabránenie poadovanıch prístupovıch práv.';
...
$lang['Conflict_access_groupauth'] = 'Nasledujúci uívate¾ (uívatelia) majú poadované práva pre toto fórum cez ich nastavené oprávnenia. Môete povoli oprávnenie skupine, alebo odstráni tohto uívate¾a zo skupiny pre úplné zabránenie poadovanıch prístupovıch práv.';
$lang['Conflict_mod_groupauth'] = 'Nasledujúci uívate¾ (uívatelia) majú poadované práva pre toto fórum cez ich nastavené oprávnenia. Môete povoli oprávnenia skupine, alebo odstráni tohto uívate¾a zo skupiny pre úplné zabránenie poadovanıch prístupovıch práv.';
...
$lang['Announce'] = 'Oznámenie';
$lang['Vote'] = 'Hlasovanie';
$lang['Pollcreate'] = 'Hlas pridanı';

$lang['Permissions'] = 'Oprávnenie';
...
$lang['Usergroup_members'] = 'Táto skupina má nasledujúcich èlenov';

$lang['Forum_auth_updated'] = 'Oprávnenie fóra bolo aktualizované.';
$lang['User_auth_updated'] = 'Uívate¾ské oprávnenie bolo aktualizované.';
$lang['Group_auth_updated'] = 'Oprávnenie skupiny bolo aktualizované.';
...
$lang['Select_email'] = 'Zvo¾te emailovú adresu';

$lang['Ban_username'] = 'Zakázanie vstupu zadanım uívate¾om';
...
$lang['Ban_email'] = 'Zakázanie vstupu pod¾a emailovıch adries';
$lang['Ban_email_explain'] = 'Tu môete zada zoznam emailovıch adries, ktorım chcete zamedzi vstup, jednotlivé adresy od seba odde¾te odde¾ovaèom. Môete poui i znak * pre nahradenie èasti adresy, napr. *@pcforum.sk';

$lang['Unban_username'] = 'Vyòatie uívate¾ov zo zoznamu zakázanıch';
$lang['Unban_username_explain'] = 'Ak chcete vyòa niektorıch uívate¾ov z tohto zoznamu, oznaète ich pomocou myši èi klávesnice a potvrïte odoslaním.';
...
$lang['Unban_email'] = 'Vyòatie emailovıch adries zo zoznamu zakázanıch';
$lang['Unban_email_explain'] = 'Ak chcete vyòa niektoré emailové adresy z tohto zoznamu, oznaète ich pomocou myši èi klávesnice a potvrïte odoslaním.';

$lang['No_banned_users'] = 'iadni zakázaní uívatelia';
$lang['No_banned_ip'] = 'iadne zakázané IP adresy';
$lang['No_banned_email'] = 'iadne zakázané emailové adresy';
...
$lang['Script_path_explain'] = 'Cesta ku skriptom phpBB2, relatívne umiestnenie v doméne.';
...
$lang['Board_disable_explain'] = 'Tımto zneprístupníte fórum pre uívate¾ov. Neodhlasujte sa pokia¾ ste zneprístupnil fórum, inak sa nebudete môc prihlási spä!';
...
$lang['Max_poll_options'] = 'Maximálny poèet moností pri hlasovaní';
...
$lang['Board_email_form'] = 'Zasiela emaily cez toto fórum';
$lang['Board_email_form_explain'] = 'Umoòuje zasielanie emailov inım uívate¾om cez toto fórum.';
...
$lang['Allow_smilies'] = 'Povoli smajlíky';
...
$lang['Allow_remote'] = 'Povoli iba odkaz na obrázky postavièiek';
$lang['Allow_remote_explain'] = 'Obrázok postavièky prepojenı na inı WWW server.';
$lang['Allow_upload'] = 'Povoli prihrávanie obrázkov postavièiek na server';
...
$lang['Avatar_gallery_path'] = 'Cesta ku galérií obrázkov postavièiek';
...
$lang['COPPA_mail'] = 'COPPA emailové adresy';
$lang['COPPA_mail_explain'] = 'Toto je zoznam adries na ktoré budú rodièia zasiela COPPA registraènı formulár.';

$lang['Email_settings'] = 'Nastavenia emailov';
$lang['Admin_email'] = 'Administrátorova emailová adresa:';
$lang['Email_sig'] = 'Podpis emailu';
$lang['Email_sig_explain'] = 'Tento text bude pripojenı ku všetkım emailom odoslanım z tohto fóra.';
$lang['Use_SMTP'] = 'Poui SMTP server pre email';
$lang['Use_SMTP_explain'] = 'Zvo¾te Áno, ak chcete odosiela emaily cez meno servera namiesto lokálnej mail funkcie.';
...
$lang['Disable_privmsg'] = 'Súkromné správy';
$lang['Inbox_limits'] = 'Max. poèet správ v zloke doruèené';
$lang['Sentbox_limits'] = 'Max. poèet správ v zloke odoslané';
$lang['Savebox_limits'] = 'Max. poèet správ v zloke uloené';

$lang['Cookie_settings'] = 'Nastavenia cookies';
...
// Visual Confirmation
$lang['Visual_confirm'] = 'Vyadova vizuálne overenie';
$lang['Visual_confirm_explain'] = 'Vyaduje prepísanie kódu, ktorı sa zobrazí v obrázku pri registrácií nového uívate¾a.';

// Autologin Keys - added 2.0.18
$lang['Allow_autologin'] = 'Povoli automatické prihlásenia';
$lang['Allow_autologin_explain'] = 'Umoòuje povoli, alebo zakáza monos automatického prihlásenia na fórum.';
$lang['Autologin_time'] = 'Doba platnosti automatického prihlásenia';
$lang['Autologin_time_explain'] = 'Tu môete nastavi, ko¾ko dní je platnı k¾úè pre automatické prihlásenie. Napíšte nulu pre neobmedzenú platnos.';

// Search Flood Control - added 2.0.20
$lang['Search_Flood_Interval'] = 'Ochrannı interval pre h¾adanie';
$lang['Search_Flood_Interval_explain'] = 'Poèet sekund, pri ktorıch uívate¾ musí èaka na ïalšie hladanie.';

//
// Forum Management
//
$lang['Forum_admin'] = 'Administrácia fóra';
$lang['Forum_admin_explain'] = 'Z tohto panelu môete pridáva, odstraòova, upravova, triedi a synchronizova kategórie a fóra.';
$lang['Edit_forum'] = 'Úprava fóra';
$lang['Create_forum'] = 'Vytvori nové fórum';
$lang['Create_category'] = 'Vytvori novú kategóriu';
$lang['Remove'] = 'Vyòa';
$lang['Action'] = 'Akcia';
$lang['Update_order'] = 'Aktualizova inštrukcie';
...
$lang['Forum_delete_explain'] = 'Nišie uvedenı formulár Vám umoní odstráni fóra èi kategórie a rozhodnú kam chcete da všetky témy, ktoré sú v òom obsiahnuté.';

$lang['Status_locked'] = 'Zamknuté';
$lang['Status_unlocked'] = 'Odomknuté';
...
// Smiley Management
//
$lang['smiley_title'] = 'Úprava smajlíkov';
$lang['smile_desc'] = 'Na tejto stránke môete pridáva, odobera a upravova smajlíky, ktoré môu Vaši uívatelia pouíva v príspevkoch a súkromnıch správach.';
...
$lang['smile_conflicts'] = 'Èo urobi v prípade konfliktov?';
...
$lang['export_smile_pack'] = 'Vytvori kolekciu smajlíkov';
...
$lang['Confirm_delete_smiley'] = 'Naozaj chcete odstráni tohto smajlíka?';
...
$lang['User_delete_explain'] = 'Tu zmaete tohto uívate¾a. POZOR! Túto akciu nieje moné vráti spä!';
$lang['User_deleted'] = 'Uívate¾ bol úspešne odstránenı.';
...
$lang['Admin_avatar_explain'] = 'Tu môete vidie a odstráni súèasnú uívate¾ovú postavièku.';
...
$lang['Group_admin_explain'] = 'Z tohto panelu môete spravova všetky uívate¾ské skupiny, môete odstráni, vytvori a meni súèasné skupiny. Môete vybera moderátorov, zamknú otvorené/uzavreté skupiny a nastavova meno a popis skupiny.';
...
$lang['delete_moderator_explain'] = 'Pokia¾ chcete zmeni moderátora skupiny, zaškrtnite toto políèko k odstráneniu pôvodného moderátora z tejto skupiny. V opaènom prípade sa tento uívate¾ stane benım èlenom tejto skupiny.';
...
$lang['Rank_image_explain'] = 'Pouite túto funkciu na definovanie malého obrázku spojeného s danım hodnotením. Cesta mimo Váš phpBB2 kmeòovı adresár a názov súboru, napr.: images/ranks/rank.png';
...
$lang['Click_return_rankadmin'] = 'Kliknite %ssem%s pre návrat do Administrácie hodnotení.';

$lang['Confirm_delete_rank'] = 'Naozaj chcete odstráni toto hodnotenie?';

//
// Disallow Username Admin
//
$lang['Disallow_control'] = 'Správa nepovolenıch uívate¾skıch mien';
$lang['Disallow_explain'] = 'Tu môete spravova uívate¾ské mená, ktoré nebudú povolené k pouitiu. Nepovolené uívate¾ské mená môu obsahova "*". Upozoròujeme, e nebudete môc urèi u zaregistrované uívate¾ské meno. Najskôr ho musíte odstráni a následne ho nepovoli.';

$lang['Delete_disallow'] = 'Odstráni';
$lang['Delete_disallow_title'] = 'Odstráni nepovolené uívate¾ské meno';
$lang['Delete_disallow_explain'] = 'Môete odstráni nepovolené uívate¾ské meno tak, e ho vyberiete zo zoznamu a stlaèíte tlaèítko Odstráni.';
...
$lang['Styles_addnew_explain'] = 'Tento zoznam obsahuje všetky motívy, ktoré sú dostupné pre vzory, ktoré teraz máte. Èasti na tomto zozname ešte neboli nainštalované do zodpovedajúcej databázy phpBB. Pre nainštalovanie kliknite na inštalaènı odkaz ved¾a zadania.';
...
$lang['Style_removed'] = 'Vybratı štıl bol odstránenı z databázy. K plnému odstráneniu tohto štılu zo systému musíte odstráni príslušnı štıl z adresára vzorov.';
...
$lang['Download_theme_cfg'] = 'Nie je moné zapisova do konfiguraèného súboru. Kliknite na spodné tlaèítko na stiahnutie súboru Vašim prehliadaèom. A ho stiahnete, môete ho presunú do adresára obsahujúceho súbory vzorov. Potom môete zabali súbory pre distribúciu, alebo poui inde, keï chcete.';
...
$lang['No_template_dir'] = 'Nie je moné otvori adresár so vzormi. Moné je, e nemáte právo na èítanie, alebo adresár neexistuje.';
$lang['Cannot_remove_style'] = 'Nie je moné odstráni vybratı štıl, ak je nastavenı ako vıchodzí. Zmeòte, prosím, pôvodnı štıl a skúste to znova.';
$lang['Style_exists'] = 'Meno štılu u existuje. Prosím vráte sa a zvo¾te iné meno.';
...
$lang['Stylesheet'] = 'CSS štıl';
$lang['Stylesheet_explain'] = 'Názov CSS súboru pouívaného tımto štılom.';
...
$lang['Th_class1'] = 'Trieda titulu tabu¾ky 1';
$lang['Th_class2'] = 'Trieda titulu tabu¾ky 2';
$lang['Th_class3'] = 'Trieda titulu tabu¾ky 3';
$lang['Td_color1'] = 'Farba bunky tabu¾ky 1';
$lang['Td_color2'] = 'Farba bunky tabu¾ky 2';
$lang['Td_color3'] = 'Farba bunky tabu¾ky 3';
$lang['Td_class1'] = 'Trieda bunky tabu¾ky 1';
$lang['Td_class2'] = 'Trieda bunky tabu¾ky 2';
$lang['Td_class3'] = 'Trieda bunky tabu¾ky 3';
...
$lang['span_class1'] = 'Trieda SPAN 1';
$lang['span_class2'] = 'Trieda SPAN 2';
$lang['span_class3'] = 'Trieda SPAN 3';
...
$lang['continue_upgrade'] = 'Po tom, èo ste si stiahli konfiguraènı súbor na Váš disk môete spodnım tlaèítkom \'Pokraèova v inštalácii novšej verzie\'. Poèkajte s nahrávaním konfiguraèného súboru dokia¾ nie je ukonèená inštalácia novšej verzie.';
$lang['upgrade_submit'] = 'Pokraèova v inštalácii novšej verzie';

$lang['Installer_Error'] = 'Poèas inštalácie sa vyskytla chyba!';
$lang['Previous_Install'] = 'Bola nájdená predchádzajúca inštalácia.';
$lang['Install_db_error'] = 'Poèas nahrávania novšej inštalácie databázy sa vyskytla chyba.';

$lang['Re_install'] = 'Vaša predchádzajúca inštalácia je stále aktívna.<br /><br />Pokia¾ si prajete preinštalova phpBB 2, pokraèujte tlaèítkom \'Áno\'. Uvedomte si, prosím, e v tomto prípade sa znièia všetky dáta; nedôjde k zálohovaniu. Administrátorské uívate¾ské meno a heslo, ktoré ste pouívali k prihláseniu budú po reinštalácii prepísané novımi, iadne ïalšie nastavenia nebudú zachované.<br /><br />Zamyslite sa pozorne pred stlaèením tlaèítka \'Áno\'!';

$lang['Inst_Step_0'] = 'Ïakujeme Vám, e ste si zvolili phpBB 2 fórum. Pre úspešnú inštaláciu vyplòte všetky poadované údaje. Databáza, do ktorej chcete fórum inštalova, musí existova. Ak pouívate databázu cez ODBC ovládaèe, vytvorte najprv DSN záznam.';

$lang['Start_Install'] = 'Zaèa inštaláciu';
$lang['Finish_Install'] = 'Ukonèi inštaláciu';

$lang['Default_lang'] = 'Vıchodzí jazyk boardu';
...
$lang['Inst_Step_2'] = 'Vaše uívate¾ské meno bolo vytvorené. V tomto momente je základná inštalácia ukonèená. Teraz budete prepnutı do ïalšej èasti, ktorá Vám umoní ïalšiu správu novej inštalácie. Skontrolujte, prosím, detaily Všeobecnıch nastavení a urobte potrebné zmeny. Ïakujeme, e ste si vybrali phpBB 2.';

$lang['Unwriteable_config'] = 'Do Vášho konfiguraèného súboru nie je moné zapisova. Kópia tohto súboru bude stiahnutá, keï kliknete na tlaèítko dole. Potom nahrajte tento súbor do adresára phpBB 2. Ïalej sa prihláste ako administrátor s heslom, ktoré ste zadali v predchádzajúcom formulári a navštívte administrátorské centrum (odkaz sa objaví v spodnej èasti kadej stránky potom, èo sa prihlásite) a skontrolujte všeobecnú konfiguráciu. Ïakujeme, e ste si vybrali phpBB 2.';
...
$lang['ftp_info'] = 'Zadajte Vaše informácie prenosu FTP';
...
// Version Check
//
$lang['Version_up_to_date'] = 'Vaša inštalácia je aktuálna, nie su dostupné iadne aktualizácie pre túto verziu phpBB.';
$lang['Version_not_up_to_date'] = 'Vaša inštalácia <b>nie je</b> aktuálna. Aktualizácia pre túto verziu phpBB je dostupná na stránkách <a href="http://www.phpbb.com/downloads.php" target="_blank">http://www.phpbb.com/downloads.php</a>.';
$lang['Latest_version_info'] = 'Posledná dostupná verzia <b>phpBB je %s</b>.';
$lang['Current_version_info'] = 'Pouívate <b>phpBB %s</b>.';
$lang['Connect_socket_error'] = 'Nie je moné nadviaza spojenie s phpBB serverom, chybová hláška je:<br />%s';
$lang['Socket_functions_disabled'] = 'Nie je moné pouí funkciu socket.';
$lang['Mailing_list_subscribe_reminder'] = 'Pre najnovšie informácie o aktualizáciach phpBB je moné sa prihlási pre <a href="http://www.phpbb.com/support/" target="_blank">zasielanie novinek na Váš email</a>.';
$lang['Version_information'] = 'Informácie o verzií';

//
// Login attempts configuration
//
$lang['Max_login_attempts'] = 'Pokusov pre prihlásenie';
$lang['Max_login_attempts_explain'] = 'Maximálny poèet pokusov pre prihlásenie na fórum.';
$lang['Login_reset_time'] = 'Doba trvania zákazu prihlasenia';
$lang['Login_reset_time_explain'] = 'Poèet minút po ktorom bude trva zákaz prihlásenia v prípade prekroèenia maximálneho poètu pokusov prihlasénia sa na fórum.';

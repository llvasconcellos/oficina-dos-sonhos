...
$faq[] = array("¿Cómo cambiar el color o tamaño de texto?", "Para cambiar el color: [color=][/color], podés escribir el nombre del color en inglés o el código hexadecimal perteneciente a él, ej. #FFFFFF, #000000.  para crear rojo [color=red]Hola![/color]. Cambiar el tamaño es similar: [size=][/size], utilizando números del 1 al 29 (muy grande!)");
$faq[] = array("¿Puedo combinar las etiquetas de formato?", "Si :)");

$faq[] = array("--","Haciendo citas de texto o código");
$faq[] = array("Citar texto en las respuestas", "Hay dos formas de hacerlo: con una referencia o sin ella, para hacerlo con referencia utiliza la opcion CITAR del foro al dar una respuesta, el mensaje a citar es anexado al suyo automáticamente como: [quote=\"\"][/quote] El otro método (sin referencia) es poner una etiqueta parecida, pero agregando el autor del texto citado, es decir: [quote=\"Anita\"]</b>Lo qe diga Anita debe ir acá, recordá incluir \"\" alrededor del nombre a citar, si no querés incluir el nombre, sólo encerrá el texto entre las etiquetas [quote][/quote]");
...
$faq[] = array("Creando una lista desordenada", "BBCode soporta dos tipos de listas, desordenadas y ordenadas, es exactamente como en HTML, sólo que con las siguientes etiquetas: Para una desordenada [list][/list], definiendo cada parte de la lista con [*]. Por ejemplo, para listar tus animales favoritos use [list][*]Vaca[*]Cuyo[*]Conejo[/list], esto generará algo como esto:<ul><li>Vaca</li><li>Cuyo</li><li>conejo</li></ul>");
$faq[] = array("Creando una lista ordenada", "El segundo tipo de lista es la ordenada, para crearla usá [list=1][/list] para crear una lista con numeración o [list=a][/list] para una con orden alfabético, cada parte de la lista se especifica tambien con [*] Por ejemplo: [list=1][*]Vaca[*]Cuyo[*]Conejo[/list] generará algo como: <ol><li>Vaca</li><li>Cuyo</li><li>conejo</li></ol>");

...
$lang['Ban_username_explain'] = 'Podes banear a múltiples usuarios en un solo paso usando apropiadamente el teclado y mouse de su computadora';
...
$lang['Confirm_delete_smiley'] = 'Esta seguro de querer borrar este Smiley?';
...
$lang['Confirm_delete_rank'] = 'Esta seguro que desea eliminar este ranking?';
...
// Version Check
//
$lang['Version_up_to_date'] = 'Su instalación se encuentra actualizada. No existen actualizaciones disponibles para su versión de phpBB';
$lang['Version_not_up_to_date'] = 'Su instalación <b>NO</b> se encuentra actualizada. Hay actualizaciones disponibles de phpBB. Por favor visite <a href="http://www.phpbb.com/downloads.php" target="_new">http://www.phpbb.com/downloads.php</a> para descargar la última versión.';
$lang['Latest_version_info'] = 'La última versión disponible es <b>phpBB %s</b>.';
$lang['Current_version_info'] = 'Ud. posee la versión <b>phpBB %s</b>.';
$lang['Connect_socket_error'] = 'No se puede establecer la conexión con el servidor principal de phpBB. Error:<br />%s';
$lang['Socket_functions_disabled'] = 'Funciones socket no disponibles.';
$lang['Mailing_list_subscribe_reminder'] = 'Para conocer acerca de las últimas novedades, <a href="http://www.phpbb.com/support/" target="_new">suscríbase a nuestras listas de correo</a>.';
$lang['Version_information'] = 'Información sobre de la versión';

//
// Login attempts configuration
//
$lang['Max_login_attempts'] = 'Numero máximo de intentos';
$lang['Max_login_attempts_explain'] = 'Número máximo de intentos fallidos de ingreso al foro.';
$lang['Login_reset_time'] = 'Tiempo de espera';
$lang['Login_reset_time_explain'] = 'Tiempo en minutos que el usuario debe esperar después de haber excedido el número máximo de intentos.';

 ...
 *                          : npeloso@unr.edu.ar
 *
 *     $Id: lang_main.php,v 1.85.2.21 2006/04/10 12:00:17 psotfx Exp $
 *
 ****************************************************************************/
...
//
// El formato de este archivo es: $lang['message'] = 'descripción';
//
// Ud. puede también puede intentar pre-establecer su juego de caracteres locales. Dicha codificación 
// será enviada a los formularios base. Esta característica puede o no funcionar, dado que depende
// del sistema operativo y de la sintaxis aplicada. Pruébelo para obtener mejores resultados!
//
...
$lang['Forum_Index'] = 'Foros de discusión';  // eg. Nombre de Sitio Indice de Foros, %s se puede agregar si lo desea. Ej: $lang['Forum_Index'] = "%s Indice de Foros";
...
$lang['Confirm_code_impaired'] = 'Si Ud. no puede visualizar el código correctamente o tiene algun otro tipo de problema, por favor pongase en contacto con el %sAdministrador%s para solicitar ayuda.';
$lang['Confirm_code'] = 'Código de confirmación';
$lang['Confirm_code_explain'] = 'Ingrese el código exactamente como aparece en pantalla. El código es sensitivo (distingue mayúsculas de minúsculas) y el cero es identificable porque una línea cruza su centro.';
...
$lang['Admin_reauthenticate'] = 'Para ingresar a la administración del foro, primero debe volver a identificarse.';
$lang['Login_attempts_exceeded'] = 'El número máximo de intentos (%s) se excedió. Ud. no esta autorizado a ingresar hasta dentro de %s minutos.';
$lang['Please_remove_install_contrib'] = 'Por favor asegúrese de que los directorios install/ y contrib/ se hallen borrados';

...
// Visual Confirmation
$lang['Visual_confirm'] = 'Визуално потвърждаване';
$lang['Visual_confirm_explain'] = 'Изисква от потребителите да въведат в процеса на регистрация случайно генериран (под формата на изображение) код.';
...
$lang['Status_locked'] = 'Заключен';
$lang['Status_unlocked'] = 'Отключен';
...
$lang['No_update_ranks'] = 'Рангът е изтрит успешно, но потребителите, използващи този ранг - не. Трябва ръчно да премахнете ранга на тези потребители.';

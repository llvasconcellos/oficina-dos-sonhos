...
// Translator credit
$lang['TRANSLATION_INFO'] = 'Translation by: <a href="http://www.flashbg.org" target="_blank">Boby Dimitrov</a>';
...
$lang['No_such_post'] = "Няма такова мнение, моля върнете се обратно и опитайте пак";
...
$lang['Empty_poll_title'] = "Трябва да въведете заглавие за анкетата";
$lang['To_few_poll_options'] = "Трябва да въведете поне два възможни избора за анкетата";
$lang['To_many_poll_options'] = "Не можете да въведете толкова много избори за анкетата";
...
$lang['Topic_reply_notification'] = "Уведомяване за отговори по темата";
...
$lang['File_no_data'] = "Файлът , чийто адрес сте въвели, не съществува";
...
$lang['Date_format_explain'] = "Синтаксисът е идентичен с функцията <a href=\"http://www.php.net/date\" target=\"_other\">date()</a> на PHP.";
$lang['Signature'] = "Подпис";
$lang['Signature_explain'] = "Това е текстови блок, който може да бъде прикачен в края на съобщенията, които пускате. Има ограничение от %d символа";
...
$lang['Delete_Image'] = "Изтрийте Аватара";
...
$lang['Password_long'] = "Паролата ви не може да е по-дълга от 32 символа!";
$lang['Too_many_registers'] = 'Извършили сте прекалено много опити за регистрация. Моля опитайте по-късно.';
...
$lang['Password_updated'] = "Зададена ви е нова парола. Моля проверете мейла си за информация как да я активирате!";
...
//
$lang['Confirm_code_wrong'] = 'Потвърдителния код, който сте въвели, е неверен';
$lang['Too_many_registers'] = 'Извършили сте прекалено много опити за регистрация в тази сесия. Моля опитайте по-късно.';
$lang['Confirm_code_impaired'] = 'Ако имате зрителни проблеми, моля свържете се с %sАдминистратор%s, който ще ви помогне.';
$lang['Confirm_code'] = 'Потвърдителен код';
$lang['Confirm_code_explain'] = 'Въведете кода точно както го виждате. Обърнете внимание на главните и малки букви - те има значение. Нулата се различава от буквата \"O\" по диагоналната линия.';
...
$lang['Deny_selected'] = "Отхвърлете селектираните";
...
$lang['Sorry_auth_vote'] = "Само %s могат да гласуват на анкети в този форум";
...
$lang['No_Topics_Moved'] = 'Теми не бяха преместени';
...
$lang['Leave_shadow_topic'] = "Остави връзка към преместената тема в стария форум";

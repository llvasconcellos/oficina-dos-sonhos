<?php
/***************************************************************************
 *                          lang_faq.php [lithuanian]
 *                            -------------------
 *   begin                : Wednesday Oct 3, 2001
 *   copyright            : (C) 2001 The phpBB Group
 *   email                : support@phpbb.com
 *
 *   $Id: lang_faq.php,v 1.1.2.1 2005/01/02 20:44:58 ProTON Exp $
 *
 *
 ***************************************************************************/
...
$faq[] = array("Kodël að negaliu prisijungti?", "Ar uþsiregistravote? Visø pirma, norint prisijungti jûs turite uþsiregistruoti. O gal jus paðalino ið diskusijø (apie tai jums turi praneðti þinutë prisijungimo metu)? Tokiu atveju jums reikëtø kreiptis á administratoriø ir paklausti kodël taip atsitiko. Jeigu jûs esate uþsiregistravæ ir nesate iðmestas ið diskusijø tada patikrinkite ar teisingai ávedëte vartotojo vardà ir slaptaþodá. Tada ir tik tada, jei ir tai neiðsprendë jûsø problemø, kreipkitës á administratoriø.");
$faq[] = array("Kodël að ið viso turiu uþsiregistruoti?", "Tai priklauso nuo administratoriaus. Jeigu taip nustatyta, vadinasi taip turi bûti. Tuo labiau, kad tik uþsiregistravus tampa prieinami papildomi dalykai, kuriais negali naudotis anoniminis dalyvis, tokie kaip avatarai, privaèios þinutës, elektroninio paðto siuntimas draugam, prisijungimas á dalyviø grupes ir panaðiai. Pati registracija uþtrunka tik keletà minuèiø, todël patartina tai padaryti (netgi bûtina).");
...
$faq[] = array("Ar galima kaip nors paslëpti mano vartotojo vardà, kad jo nesimatytø dabar diskusijoje dalyvaujanèiø sàraðe?", "Savo profilio apraðyme galite rasti <i>Paslëpti jûsø bûsenà</i> parametrà. Jeigu já ájungsite apie jûsø prisijungimus þinos tik administratoriai. Tapsite vienu ið <i>Paslëptø vartotojø</i>.");
...
$faq[] = array("Neteisingi laikai! Kà galima bûtø padaryt?", "Ið tikrøjø laikai yra teisingi, taèiau greièiausiai jie neatitinka jûsø laiko juostos. Tokiu atveju savo nustatymuose turite teisingai nusistatyti laiko juostà, kad ji atitiktø norimà laikà. Lietuva ðiuo metu yra GMT+2 laiko juostoje. Taèiau pastebëkite, kad tik registruoti vartotojai gali keisti laiko juostas (kaip ir daugelá kitø nustatymø). Taigi jeigu dar neuþsiregistravote, pats metas bûtø tai padaryti.");
$faq[] = array("Pakeièiau laiko juostas kaip jûs man sakëte, taèiau laikai vistiek neteisingi!", "Neteisingus laikus gali rodyti ir dël tokio dalyko, kaip vasaros laikas. Ði diskusijø lenta nëra pritaikyta pasikeitimams tarp standartinio ir vasaros laiko, todël kartais vasarà diskusijose laikas skiriasi viena valanda.");
$faq[] = array("Kalbø sàraðe að nerandu savo kalbos!", "Greièiausiai jûsø norima kalba neádiegta arba tiesiog niekas dar neiðvertë ðios diskusijø lentos á tà kalbà. Jeigu vertimas egzistuoja, pabandykite papraðyti administratoriaus, kad jis ádiegtø jums reikiamà kalbà. Kitu atveju galite iðsiversti patys. Daugiau informacijos rasite phpBB grupës puslapyje (www.phpbb.com).");
...
$faq[] = array("Kaip man pasikeisti savo rangà?", "Daþniausiai jûs neturite teisës keisti rangø. Daugumoje diskusijø forumø rangai þymi þinuèiø skaièiø, arba specialiais rangais paþymimi ypatingi dalyviai, tokie kaip administratoriai, moderatoriai ir t.t. Neraðinëkite nereikalingø þinuèiø vien tam, kad pakeltumëte savo rangà, nes jums tiesiog bus uþdrausta kà nors iðvis raðyti.");
...
$faq[] = array("Kaip man regaduoti arba iðtrinti apklausà?", "Kaip ir þinutes, apklausà gali redaguoti tik tas, kuris jà sukûrë, arba moderatorius ar forumo administratorius. Redaguoti balsavimà galima taip: paspaudþiate ant pirmos þinutës temoje. Paprasti vartotojai gali redaguoti ir iðtrinti tik tuo atveju, jeigu niekas dar nebalsavo. Kitu atveju keisti apklausà gali tik moderatoriai arba administratoriai.");
...
$faq[] = array("Ar galiu naudoti HTML?", "Tai priklauso nuo diskusijø administratoriø. Jeigu jie ir ájungs HTML, tai greièiausiai neveiks kai kurie þymenys (tags). Taip yra daroma vël gi dël saugumo. Jeigu HTML ájungtas, já galima iðjungti atskirai raðant kiekvienà þinutæ.");
...
$faq[] = array("Kas yra svarbios temos?", "Jose daþniausiai raðoma ypatingai svarbi informacija, kurià jûs turëtumete perskaityti kuo skubiau. Tokias temas gali kurti tiek administratoriai, tiek ir paprasti vartotojai, priklausomai nuo to kaip nustatytos viso diskusijø teisës.");
$faq[] = array("Kas yra daþnos temos?", "Daþnos temos rodomos þemiau svarbiø temø, bet virð visø kitø temø. Kaip ir svarbias temas, daþnas temas gali kurti visi, kuriems tai leidþia nustatytos teisës.");
...
$faq[] = array("Kas yra administratoriai?", "Administratoriai - tai þmonës, kuriems buvo suteikta aukðèiausia valdþia visoje diskusijø lentoje. Ðie þmonës gali kontroliuoti viskà, pradedant vartotojø teisëmis, dalyviø paðalinimu ir baigiant vartotojø grupiø ar moderatoriø kûrimu. Be to jie turi visas teises moderuoti bet kurá forumà arba temà.");
$faq[] = array("Kas yra moderatoriai?", "Moderatoriai priþiûri diskusijas diena po dienos. Jie gali trinti, keisti þinutes, trinti, perkelti, iðskirti, uþrakinti arba atrakinti temas. Pagrinde moderatoriai priþiûri, kad dalyviai nenukryptø nuo temos, nesikeiktø ir kitaip nepaþeidinëtø moralës normø.");
$faq[] = array("Kas yra vartotojø grupës?", "Kai kurie diskusijø dalyviai grupuojami á vartotojø grupes. Kiekvienas dalyvis gali priklausyti kelioms grupëms, o kiekviena grupë gali turëti skirtingas teises kiekviename forume. Tai labai palengvina administratoriø darbà, nereikia keisti kiekvieno vartotojo teisiø, galima tiesiog pakeisti teises visai grupei.");
...
//
$faq[] = array("--","phpBB 2 informacija");
$faq[] = array("Kas paraðë ðià diskusijø lentà?", "Ðis produktas (savo originalioje formoje) yra pagamintas ir iðleistas <a href=\"http://www.phpbb.com/\" target=\"_blank\">phpBB Grupës</a>. Ði diskusijø lenta, kaip programinis produktas yra platinamas po GNU GPL licenzija. Daugiau informacijos rasite adresu <a href=\"http://www.phpbb.com/\" target=\"_blank\">www.phpbb.com</a>.");
$faq[] = array("Kodël diskusijose nëra galimybës X?", "Ðá produktà sukûrë phpBB Grupë. Jeigu tikrai manote kad diskusijø lentoje trûksta kokios nors galimybës, apsilankykite phpbb.com puslapyje. Neraðykite apie tai phpbb.com diskusijø lentoje, nes phpBB Grupë naudoja sourceforge.net tam dalykui. Taip pat prieð kà nors ten raðydami, pasitikrinkite ar tokios galimybës jau nepasiûlë kas nors kitas.");
$faq[] = array("Su kuo turëèiau susisiekti dël áþeidþianèios informacijos ðioje diskusijø lentoje?", "Jûs turite susisiekti su ðiø diskusijø administratoriumi. Jeigu neþinote kas jis toks, pabandykite papraðyti pagalbos diskusijø moderatoriø. Taip pat galite pabandyti susisiekti su internetinio adreso, kuriame yra diskusijø lenta, administratoriumi. Arba jeigu tai yra nemokamas servisas (pvz. yahoo, free.fr, f2s.com, ir t.t.), susisiekite su techninës pagalbos departamentu. Ásidëmëkite, kad phpBB Grupë visiðkai nekontroliuoja ir negali kontroliuoti kur, kaip ir kokiu bûdu naudojama ði diskusijø lenta. Nëra jokio tikslo susisiekti su phpBB Grupe jeigu tai nelieèia phpbb.com puslapio ar phpBB programinës árangos. Jeigu vis dëlto susisieksite su jais, pasiruoðkite gauti grubø arba iðvis nesulaukti jokio atsakymo.");

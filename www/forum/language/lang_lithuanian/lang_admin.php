...
$lang['Sticky'] = 'Kurti daþnas temas';
$lang['Announce'] = 'Kurti svarbias temas'; 
$lang['Vote'] = 'Balsuoti';
...
$lang['Ban_explain_warn'] = 'Atsiminkite, kad ávedus IP adresø intervalà, visi adresai nuo intervalo pradþios iki pabaigos bus pridëti á blokuojamø adresø sàraðà. Duomenø bazës vietos taupymo tikslais automatiðkai bus pritaikyti specialûs sutrumpinimo simboliai. Jeigu tikrai norite ávesti adresø intervalà, geriau kad jis bûtø maþas.';
...
$lang['Ban_IP_explain'] = 'IP adresams ir internetiniams vardams atskirti naudokite kablelá. Taip pat galite pasirinkti blokuoti adresø intervalà. Tai daroma taip: pirmas_ip_adresas-paskutinis_ip_adresas. Dalinëms reikðmëms apibûdinti naudokite *';
...
// Visual Confirmation
$lang['Visual_confirm'] = 'Ájungti vaizdiná patvirtinimà';
$lang['Visual_confirm_explain'] = 'Reikalauja naujiems besiregistruojantiems vartotojams ávesti kodà kuris yra pavaizduotas paveikslëlyje.';

// Autologin Keys - added 2.0.18
$lang['Allow_autologin'] = 'Leisti automatinius prisijungimus';
$lang['Allow_autologin_explain'] = 'Nustato ar vartotojui leidþiama pasirinkti ir naudoti automatiná prisijungimà kiekvieno vizito metu';
$lang['Autologin_time'] = 'Automatinio prisijungimo rakto galiojimas';
$lang['Autologin_time_explain'] = 'Kiek dienø galioja automatinis prisijungimo raktas jeigu vartotojas nelanko diskusijø lentos. Norëdami iðjungti áraðykite nulá.';

// Search Flood Control - added 2.0.20
$lang['Search_Flood_Interval'] = 'Paieðkos mechanizmo apsauga';
$lang['Search_Flood_Interval_explain'] = 'Laiko tarpas sekundëmis tarp kiekvienos vartotojo atliktos paieðkos uþklausos'; 
...
$lang['Confirm_delete_smiley'] = 'Ar tikrai norite iðtrinti ðià ðypsenëlæ?';
...
$lang['Confirm_delete_word'] = 'Ar tikrai norite iðtrinti ðá cenzûruojamà þodá?';
...
$lang['Confirm_delete_rank'] = 'Ar tikrai norite iðtrinti ðá rangà?';
...
$lang['Stylesheet_explain'] = 'Failo pavadinimas, kurá norite naudoti ðiam stiliui.';
...
// Version Check
//
$lang['Version_up_to_date'] = 'Jûs naudojate naujausià phpBB versijà. Ji nereikalauja jokiø atnaujinimø.';
$lang['Version_not_up_to_date'] = 'Jûs naudojate <b>ne</b> naujausià phpBB versijà. Norëdami gauti naujausià versijà apsilankykite <a href="http://www.phpbb.com/downloads.php" target="_new">http://www.phpbb.com/downloads.php</a> puslapyje.';
$lang['Latest_version_info'] = 'Naujausia versija yra <b>phpBB %s</b>.';
$lang['Current_version_info'] = 'Jûsø versija yra <b>phpBB %s</b>.';
$lang['Connect_socket_error'] = 'Prisijungti prie phpBB serverio nepavyko, gauta klaida:<br />%s';
$lang['Socket_functions_disabled'] = 'Nepavyko panaudoti socket funkcijø.';
$lang['Mailing_list_subscribe_reminder'] = 'Norëdami gauti naujausià informacijà apie phpBB uþsiregistruokite á <a href="http://www.phpbb.com/support/" target="_new">mûsø el. paðto konferencijà</a>.';
$lang['Version_information'] = 'Versijos informacija';

//
// Login attempts configuration
//
$lang['Max_login_attempts'] = 'Neteisingø prisijungimø skaièius';
$lang['Max_login_attempts_explain'] = 'Nustato kiek kartø leisti vartotojams bandyti prisijungti.';
$lang['Login_reset_time'] = 'Vartotojo vardo uþrakinimas';
$lang['Login_reset_time_explain'] = 'Kiek minuèiø vartotojas turi laukti kol vël galës prisijungti po iðnaudotø nepavykusiø prisijungimø skaièiaus.';

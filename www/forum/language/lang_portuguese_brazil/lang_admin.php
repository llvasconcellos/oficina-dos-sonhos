...
$lang['Permissions List'] = 'Listar Permissões';
...
$lang['Backup'] = 'Copiar';
$lang['Restore_explain'] = 'Isso executará uma restauração completa de todas as tabelas do phpBB a partir de um arquivo salvo. Caso o seu servidor permita você poderá enviar um arquivo de texto compactado em Gzip e ele será descompactado automaticamente. <b>ATENÇÃO</b> Esta operação sobrescreverá qualquer informação existente. Dependendo do tamanho de seu Banco de Dados este processo poderá levar algum tempo. Não saia desta página para outra até que o processo seja finalizado. ';
...
$lang['Ban_email'] = 'Banir um ou mais endereços de e-mail';
$lang['Ban_email_explain'] = 'Quando usar mais que um e-mail separe cada item com uma vírgula. Para especificar um usuário qualquer de um certo provedor, utilize asteriscos \'*\', como por exemplo, *@hotmail.com';

$lang['Unban_username'] = 'Remover a expulsão de um ou mais Usuários';
$lang['Unban_username_explain'] = 'Você pode remover a expulsão de vários Usuários simultaneamente usando a combinação apropriada de teclas e cliques do mouse no seu computador ou navegador.';
...
$lang['Unban_email'] = 'Remover a expulsão de um ou mais endereços de e-mail';
$lang['Unban_email_explain'] = 'Pode remover a expulsão de vários endereços de e-mail simultaneamente usando a combinação apropriada de teclas e cliques do mouse no seu computador ou browser.';

$lang['No_banned_users'] = 'Não há Nomes de Usuários banidos';
$lang['No_banned_ip'] = 'Não há endereços de IP banidos';
$lang['No_banned_email'] = 'Não há endereços de e-mail banidos';
...
$lang['Config_explain'] = 'O Formulário abaixo te permitirá personalizar todas as opções gerais do seu phpBB. Para configurações de Fóruns ou Usuários use os respectivos links no painel esquerdo.';
...
$lang['Board_disable_explain'] = 'Isto torna os fóruns inacessíveis aos usuários, mas os Administradores ainda poderão efetuar login para reativar o fórum.';
...
$lang['Acct_activation'] = 'Usar a função de ativação de registro';
...
$lang['Board_email_form_explain'] = 'Função que permite Usuários enviar e-mail a outros através do phpBB';
...
$lang['Allow_smilies'] = 'Permitir Emoções';
$lang['Smilies_path'] = 'Pasta dos Emoções';
...
$lang['COPPA_mail'] = 'Endereço de e-mail para COPPA';
$lang['COPPA_mail_explain'] = 'Este é o endereço de e-mail para o qual os pais enviarão os formulários de registro de COPPA';

$lang['Email_settings'] = 'Configuração de E-mail';
$lang['Admin_email'] = 'Endereço de E-mail do Administrador';
$lang['Email_sig'] = 'Assinatura do E-mail';
$lang['Email_sig_explain'] = 'Este texto será anexado a todos os e-mails enviados pelo fórum';
$lang['Use_SMTP'] = 'Usar Servidor de SMTP para o envio';
$lang['Use_SMTP_explain'] = 'Selecione SIM caso queira ou tenha que enviar E-mail através de um servidor em vez da função mail() do PHP';
...
$lang['SMTP_password_explain'] = 'Só escreva a Senha caso o seu servidor de SMTP assim o exija';
...
// Visual Confirmation
$lang['Visual_confirm'] = 'Habilitar Confirmação Visual';
$lang['Visual_confirm_explain'] = 'Exige que os usuários informem um código definido por uma imagem no ato do registro.';

// Autologin Keys - added 2.0.18
$lang['Allow_autologin'] = 'Permitir logins automáticos';
$lang['Allow_autologin_explain'] = 'Determina se os usuários estão autorizados a selecionar serem logados automaticamente ao visitar o fórum';
$lang['Autologin_time'] = 'Expiração da chave automática de login';
$lang['Autologin_time_explain'] = 'Por quanto tempo, em dias, uma chave de auto-login é válida se o usuário não visitar o fórum. Use 0 para desabilitar a expiração. ';

// Search Flood Control - added 2.0.20
$lang['Search_Flood_Interval'] = 'Intervalo de Pesquisas';
$lang['Search_Flood_Interval_explain'] = 'Número de segundos que o usuário deverá aguardar entre as pesquisas realizadas';
...
$lang['Set_prune_data'] = 'Você ativou a função para auto-limpar o fórum mas não especificou a freqüência ou número de dias em que o mesmo deve ser limpo. Volte e especifique esse valor';
...
// Smiley Management
//
$lang['smiley_title'] = 'Administração de Smilies';
$lang['smile_desc'] = 'A partir dessa página você pode adicionar, remover e editar as emoções ou smilies que os Usuários poderão usar nas suas mensagens.';

$lang['smiley_config'] = 'Configuração de Smilies';
$lang['smiley_code'] = 'Código para o Smilie';
$lang['smiley_url'] = 'Arquivo da imagem do Smilie';
$lang['smiley_emot'] = 'Emoção do Smilie';
$lang['smile_add'] = 'Adicionar um Smilie';
$lang['Smile'] = 'Imagem';
$lang['Emotion'] = 'Expressão do Smilie';
...
$lang['smiley_import_inst'] = 'Você deve descompactar o pacote de Smilies e colocar todos os arquivos na respectiva pasta da sua instalação do phpBB.  Selecione depois a informação correta neste formulário para importar o pacote. ';
...
$lang['export_smiles'] = 'Para criar um pacote de Smilies a partir dos atualmente instalados, primeiro clique %sAqui%s para fazer download do pacote smiles.pak. Renomeie este arquivo apropriadamente, mantendo a extensão .pak.  Então crie um arquivo zip contendo todos as suas imagens de Smilie mais este arquivo de configuração (.pak).';
...
$lang['Click_return_smileadmin'] = 'Clique %sAqui%s para voltar à Administração de Smilies';
$lang['Confirm_delete_smiley'] = 'Você tem certeza que deseja remover este Smilie?';
...
$lang['User_admin_explain'] = 'Aqui você pode mudar a informação dos seus Usuários além de algumas opções específicas. Para modificar as permissões de Usuários use o painel de <b>Permissões</b> para Usuários e Grupos. ';
...
$lang['delete_moderator_explain'] = 'Se estiver alterando o moderador do grupo assinale aqui para remover o moderador anterior.  Caso contrário não assinale e o Usuário passará a ser um membro normal do grupo. ';
...
$lang['Confirm_delete_word'] = 'Você tem certeza que deseja remover esta Palavra Censurada?';


//
// Mass Email
//
$lang['Mass_email_explain'] = 'A partir daqui você pode enviar um e-mail para todos os Usuários dos fóruns ou Usuários membros de um certo grupo, pra tal empregue o endereço de <b>E-mail Administrativo</b> previamente configurado. Caso seja enviado um e-mail para um número elevado de pessoas aguarde um pouco após clicar abaixo em <b>E-mail</b> e não pare a página durante o processo - é normal que o envio de um e-mail em massa demore um pouco, mas você será avisado quando o processo for concluído. ';
$lang['Compose'] = 'Compor';
...
$lang['No_update_ranks'] = 'O Rank foi excluído com sucesso. Entretanto, contas de usuários que utilizam esse rank não foram atualizadas.  Você precisará alterar o rank dessas contas manualmente';

$lang['Click_return_rankadmin'] = 'Clique %sAqui%s para voltar a Gerência de Ranks';
$lang['Confirm_delete_rank'] = 'Você tem certeza que deseja remover este Rank?';
...
$lang['Click_return_disallowadmin'] = 'Clique %sAqui%s para voltar ao Painel de Controle de Nomes de Usuários Proibidos';
...
$lang['Create_theme_explain'] = 'Use o formulário abaixo para criar um Tema novo para o Modelo existente. Quando aplicar cores (que devem ser escritas num formato hexadecimal) não deve ser incluído o # inicial, ou seja, CCCCCC é a forma correta de escrever, #CCCCCC é incorreto. ';

$lang['Export_themes'] = 'Exportar Temas';
$lang['Export_explain'] = 'Usar este painel para exportar informação de um Tema para um dado Modelo. Escolha um Modelo na lista e será automaticamente criado um arquivo de configuração do tema que irá ser guardado e instalado na pasta do Modelo selecionado. Caso não for possível guardar o arquivo por si próprio será dada a opção para ser feito o seu \'download\'. Deve haver ou ser dada permissão de escrita ao servidor de WEB para a pasta do Modelo selecionado de forma que o arquivo seja guardado. Para mais informação sobre esta operação ver o <b>phpBB 2 users guide</b>.';
...
$lang['Theme_info_saved'] = 'A informação do tema para o Modelo selecionado foi guardada. Você deve agora mudar as permissões para \'read-only\' no arquivo theme_info.cfg (e caso aplicável na pasta de Modelos)';
$lang['Theme_updated'] = 'O tema selecionado foi atualizado. Você deve agora exportar a nova configuração do tema';
$lang['Theme_created'] = 'Tema criado. Você deve agora exportar o tema para o arquivo de configuração do tema como segurança ou usar em outro local';

$lang['Confirm_delete_style'] = 'Tem a certeza que quer remover este estilo?';

$lang['Download_theme_cfg'] = 'Não foi possível escrever o arquivo de informação do tema. clique o botão abaixo para fazer o \'download\' deste arquivo com o seu \'navegador\'. Logo que termine o download poderá transferir o arquivo para a pasta contendo os arquivos do Modelo. Pode depois arrumar os arquivos para distribuição ou usar noutro local, se assim o pretender';
$lang['No_themes'] = 'O Modelo que selecionou não Possui temas anexos. Para criar um tema novo clique em Criar no painel do lado esquerdo';
...
$lang['continue_upgrade'] = 'Logo que tenha terminado o download do arquivo de configuração para o seu computador poderá clicar em \"Continuar a Atualização\" abaixo para continuar o processo.  Aguarde que seja feito o upload do arquivo de configuração até que o processo de atualização esteja completo. ';
...
$lang['Re_install'] = 'A sua instalação anterior ainda se encontra ativa. <br /><br />Se pretende reinstalar phpBB 2 deverá clicar no botão Sim abaixo. Tenha atenção que ao reinstalar o phpBB 2 todas as informações existentes serão apagadas, não sendo feitas cópias de segurança! O Nome de Usuário e Senha de administrador que você tem usado para logar-se ao fórum será recriada após esta reinstalação, não sendo quaisquer outros dados de configuração salvados. <br /><br />Pense cautelosamente antes de clicar em Sim!';

$lang['Inst_Step_0'] = 'Obrigado por ter escolhido phpBB 2. Para completar esta instalação preencha os detalhes pedidos abaixo. Note que o banco de dados onde as informações do fórum serão instaladas já deve existir. Caso vá instalar o phpBB 2 num banco de dados que use ODBC, ou seja, MS Acess, deve primeiro ser criado um DS.';
...
$lang['Inst_Step_2'] = 'O seu Nome de Usuário para Administrador foi criado.  Neste momento a Instalação Básica está concluída. Irá ser conduzido agora a um painel onde poderá administrar a sua nova instalação. Verificar os detalhes de Configuração Geral e proceder às mudanças necessárias. Obrigado por usar phpBB 2.';

$lang['Unwriteable_config'] = 'O seu arquivo de configuração não pode ser escrito neste momento. Será feita uma cópia do arquivo quando carregar no botão abaixo. Deverá colocar este arquivo na mesma pasta que o phpBB 2. Uma vez concluído, você deverá logar-se usando o Nome de Usuário de administrador e respectiva senha que forneceu anteriormente visitando de seguida o Painel de Administração (um atalho irá surgir na parte inferior de cada janela) para verificar a configuração geral. Obrigado por escolher phpBB 2.';
...
$lang['NoFTP_config'] = 'A tentativa de FTP o arquivo de configuração para o local correto falhou. Por favor, fazer o download do mesmo e efetuar o FTP manualmente. ';
...
// Version Check
//
$lang['Version_up_to_date'] = 'A sua versão está em dia, não há atualizações para a sua versão do phpBB.';
$lang['Version_not_up_to_date'] = 'Sua instalação <b>não</b> está em dia. Atualizações são necessárias para a versão do seu phpBB, por favor visite <a href="http://www.phpbb.com/downloads.php" target="_new">http://www.phpbb.com/downloads.php</a> para obter a última versão.';
$lang['Latest_version_info'] = 'A última versão lançada é a <b>phpBB %s</b>.';
$lang['Current_version_info'] = 'Você está usando o <b>phpBB %s</b>.';
$lang['Connect_socket_error'] = 'Impossível abrir conexão com o servidor do phpBB.com, o erro reportado é:<br />%s';
$lang['Socket_functions_disabled'] = 'Desativado para usar funções de socket.';
$lang['Mailing_list_subscribe_reminder'] = 'Para receber as últimas informações e notícias sobre o phpBB, clique <a href="http://www.phpbb.com/support/" target="_new">aqui</a> e cadastre seu e-mail.';
$lang['Version_information'] = 'Informação da versão';

//
// Login attempts configuration
//
$lang['Max_login_attempts'] = 'Tentativas permitidas de login';
$lang['Max_login_attempts_explain'] = 'O número de tentativas de logins permitidos.';
$lang['Login_reset_time'] = 'Tempo para bloqueio de login';
$lang['Login_reset_time_explain'] = 'Tempo em minutos que o usuário tem que esperar até que esteja permitido a logar-se outra vez após ter excedido o número de tentativas permitidas de login.';

 ...
 *
 *     $Id: lang_main.php,v 2.0 2006/04/07 15:24:37 JuniorZ Exp $
 *
 ****************************************************************************/
...
$lang['Online_users_zero_total'] = 'Não há <b>nenhum</b> Usuários on-line :: ';
$lang['Online_users_total'] = 'Há <b>%d</b> usuários on-line :: ';
$lang['Online_user_total'] = 'Há <b>%d</b> usuário on-line :: ';
...
$lang['Record_online_users'] = 'O recorde de usuários on-line foi de <b>%s</b> em %s'; // first %s = number of users, second %s is the date.
...
$lang['Posted_article_total'] = 'Os nossos usuários colocaram um total de <b>%d</b> mensagem'; // Number of posts
$lang['Registered_users_zero_total'] = 'Não temos <b>nenhum</b> usuário registrado'; // # registered users
...
$lang['Rules_reply_cannot'] = 'Responder Tópicos <b>Proibido</b.>';
...
$lang['Send_email'] = 'Enviar e-mail ao Usuário';
...
$lang['No_post_mode'] = 'Não foi especificado a ação para esta mensagem'; // If posting.php is called without a mode (newtopic/reply/delete/etc, shouldn't be shown normaly)
...
$lang['Poll_question'] = 'Título da Enquete';
$lang['Poll_option'] = 'Opção de escolha';
$lang['Add_option'] = 'Adicionar esta opção';
...
$lang['Disable_Smilies_post'] = 'Desativar Smilies nesta mensagem';
...
$lang['Smilies_are_ON'] = 'Smilies estão <u>Ativos</u>';
$lang['Smilies_are_OFF'] = 'Smilies estão <u>Inativos</u>';
...
$lang['More_emoticons'] = 'Mais Smilies';
...
$lang['Disable_Smilies_pm'] = 'Desativar Smilies nesta mensagem';
...
$lang['Poster_rank'] = 'Rank do Autor';
...
$lang['No_send_account_inactive'] = 'A sua senha não pode ser recuperada porque o seu registro encontra-se atualmente Inativo. Por favor, contate o administrador do fórum para mais informações';

$lang['Always_smile'] = 'Sempre ativar os Smilies';
...
$lang['Always_notify_explain'] = 'Envia-lhe um e-mail quando alguém responde a uma mensagem que você tenha enviado. Isto pode ser alterado sempre que escrever uma mensagem.';
...
$lang['Public_view_email'] = 'Sempre exibir meu endereço de E-mail';

$lang['Current_password'] = 'Senha atual';
$lang['New_password'] = 'Senha nova';
$lang['Confirm_password'] = 'Confirmar senha';
$lang['Confirm_password_explain'] = 'Você precisa confirmar sua senha atual caso pretenda mudá-la ou alterar o endereço de e-mail';
...
$lang['Avatar'] = 'Avatar';
$lang['Avatar_explain'] = 'Exibe uma pequena imagem gráfica abaixo de seus detalhes nas mensagens. Apenas uma imagem pode ser mostrada de cada vez. A largura não pode exceder %d pixels, a altura não pode ser superior a %d pixels. O tamanho da imagem não pode exceder %dkB.';
$lang['Upload_Avatar_file'] = 'Enviar Avatar do seu computador';
...
$lang['Link_remote_Avatar_explain'] = 'Escreva a URL que contém a imagem de Avatar que você deseja exibir.';
$lang['Avatar_URL'] = 'URL da imagem de Avatar';
$lang['Select_from_gallery'] = 'Selecionar um Avatar da galeria';
$lang['View_avatar_gallery'] = 'Exibir a galeria';

$lang['Select_avatar'] = 'Selecionar o avatar';
...
$lang['Notify_on_privmsg'] = 'Notificar-me por e-mail quando houver Mensagens Particulares novas';
...
$lang['Profile_updated_inactive'] = 'O seu perfil foi atualizado, entretanto você alterou detalhes vitais e como tal o seu registro está Inativo. Verifique o seu e-mail para saber como reativar o registro, ou se for necessária a reativação pelo administrador aguarde que tal seja feito';
...
$lang['Username_invalid'] = 'Este nome de Usuário contém algum caractere inválido, tal como "';
$lang['Username_disallowed'] = 'Não é permitido o uso deste nome de Usuário';
$lang['Email_taken'] = 'Esse endereço de e-mail já se encontra registrado por outro Usuário';
$lang['Email_banned'] = 'Este endereço de e-mail encontra-se Banido';
$lang['Email_invalid'] = 'Este endereço de e-mail é Inválido';
...
$lang['Account_inactive'] = 'O seu registro foi criado. Contudo este fórum requer que o mesmo seja ativado, uma senha para o tal foi enviada para o endereço de e-mail fornecido. Por favor, verifique o seu e-mail para mais informações';
...
$lang['Wrong_activation'] = 'A senha de ativação fornecida não coincide com nenhuma que se encontra no Banco de Dados';
...
$lang['No_email_match'] = 'O endereço de e-mail fornecido não é igual ao que se encontra designado para esse nome de Usuário';
$lang['New_password_activation'] = 'Ativação de Nova Senha';
$lang['Password_activated'] = 'O seu registro foi reativado. Para logar-se, por favor, use a senha que lhe foi fornecida no e-mail que recebeu';

$lang['Send_email_msg'] = 'Enviar E-mail';
$lang['No_user_specified'] = 'Não foi especificado um Usuário';
$lang['User_prevent_email'] = 'Este Usuário não pretende receber e-mail. Tente enviar-lhe uma Mensagem Particular';
$lang['User_not_exist'] = 'Esse Usuário não existe';
$lang['CC_email'] = 'Enviar uma cópia deste e-mail para si próprio';
$lang['Email_message_desc'] = 'Esta mensagem será enviada em texto, por favor não inclua qualquer código HTML ou BBCode. Para o endereço de devolução será colocado o seu endereço de e-mail. ';
$lang['Flood_email_limit'] = 'Você não pode enviar outro e-mail neste momento, tente novamente mais tarde';
...
//
$lang['Confirm_code_wrong'] = 'O código de confirmação informado não está correto';
$lang['Too_many_registers'] = 'Você excedeu o limite de tentativas de registros para essa sessão. Por favor, tente novamente mais tarde. ';
$lang['Confirm_code_impaired'] = 'Se você possua alguma deficiência visual ou não consegue ler esse código de nenhuma maneira, por favor contate o %sAdministrador%s para obter ajuda.';
$lang['Confirm_code'] = 'Código de confirmação';
$lang['Confirm_code_explain'] = 'Informe o código exatamente como você o vê. Letras maiúsculas são diferentes de minúsculas (case-sensitive) e os zeros possuem uma linha diagonal que os atravessa. ';
...
$lang['Search_Flood_Error'] = 'Você não pode fazer uma outra pesquisa tão rapidamente; por favor tente novamente daqui alguns segundos.';
...
$lang['You_been_banned'] = 'Você foi expulso deste fórum<br />Contate o webmaster ou o administrador para mais informação';


//
// Viewonline
//
$lang['Reg_users_zero_online'] = 'Não há Usuários on-line e '; // There ae 5 Registered and
$lang['Reg_users_online'] = 'Há %d Usuários on-line e '; // There ae 5 Registered and
$lang['Reg_user_online'] = 'Há %d Usuário on-line e '; // There ae 5 Registered and
...
$lang['Guest_users_online'] = 'Há %d visitantes on-line'; // There are 10 Guest users online
$lang['Guest_users_zero_online'] = 'Não há visitantes on-line'; // There are 10 Guest users online
$lang['Guest_user_online'] = 'Há %d visitante on-line'; // There is 1 Guest user online
...
$lang['Admin_reauthenticate'] = 'Para administrar o fórum é preciso realizar nova autenticação.';

$lang['Login_attempts_exceeded'] = 'O número máximo de %s tentativas de login foi excedido. Você não está autorizado à logar-se nos próximos %s minutos. ';
$lang['Please_remove_install_contrib'] = 'Por favor, apague  as pastas <b>/contrib</b> e <b>/install</b> para continuar';

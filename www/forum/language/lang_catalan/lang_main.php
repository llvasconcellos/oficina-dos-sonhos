...
// Millores diverses        : markus_petrux
...
// please add it here.
$lang['TRANSLATION_INFO'] = '<a href="http://www.phpbb.cat/" target="_new">Traducció: Isaac Garcia Abrodos</a>';
...
$lang['Cannot_delete_replied'] = 'Ho sentim però no pots esborrar missatges als quals ja s\'hagi respost';
...
$lang['Avatar'] = 'Avatar';
$lang['Avatar_explain'] = 'Mostra una petita imatge sota els teus detalls als missatges. Només es pot mostrar una imatge cada vegada, la seva amplada no pot ser major que %d pixels, la seva alçada no major que %d pixels i la mida de l\'arxiu no més de %d kB';
$lang['Upload_Avatar_file'] = 'Pujar Avatar des del teu PC';
...
//
// Cadenes del sistema de confirmació visual
//
$lang['Confirm_code_wrong'] = 'El codi de confirmació que has introduït no és correcte';
$lang['Too_many_registers'] = 'Has sobrepassat el nombre màxim d\'intents de registre durant aquesta sessió. Si us plau intenta-ho més tard.';
$lang['Confirm_code_impaired'] = 'Si tens problemes de visió o per algun motiu no pots llegir aquest codi, et preguem que et posis en contacte amb %sl\'Administrador%s per sol·licitar ajuda.';
$lang['Confirm_code'] = 'Codi de confirmació';
$lang['Confirm_code_explain'] = 'Escriu el codi exactament com es veu. Cal respectar majúscules i minúscules; els zeros apareixen amb una línia diagonal.';
...
$lang['Search_Flood_Error'] = 'No es possible fer cerques tan seguides; si us plau torna-ho a intentar d\'aquí a un moment.';

$lang['Close_window'] = 'Tancar la finestra';
...
$lang['Admin_reauthenticate'] = 'Per administrar del fòrum cal que et tornis a identificar.';
$lang['Login_attempts_exceeded'] = 'Has sobrepassat els %s intents permesos per a identificar-te. No se\'t permet iniciar la sessió durant els següents %s minuts.';
$lang['Please_remove_install_contrib'] = 'Si us plau assegura\'t d\'esborrar els directoris install/ i contrib/';

...
$lang['Smilies_path_explain'] = 'Ruta des del directori phpBB on es troben els smileys, p.e. images/smiles';
...
$lang['Avatar_storage_path_explain'] = 'Ruta des del directori de phpBB on es troben els avatars, p.e. images/avatars';
$lang['Avatar_gallery_path'] = 'Ruta de la Galeria d\'Avatars';
$lang['Avatar_gallery_path_explain'] = 'Ruta des del directori de phpBB on es troba la galeria, p.e. images/avatars/gallery';
...
// Confirmació Visual
$lang['Visual_confirm'] = 'Habilitar la confirmació visual';
$lang['Visual_confirm_explain'] = 'Exigeix als usuaris que, en registrar-se, introdueixin un codi que es mostra en una imatge.';

// Claus d'inici de sessió automàtica - afegit a la versió 2.0.18
$lang['Allow_autologin'] = 'Permetre l\'inici automàtic de sessió';
$lang['Allow_autologin_explain'] = 'Determina si els usuaris poden utilitzar l\'opció d\'inici de sessió automàtica quan visiten el fòrum';
$lang['Autologin_time'] = 'Caducitat de la clau d\'inici de sessió automàtica';
$lang['Autologin_time_explain'] = 'Temps en dies durant el qual una clau d\'inici de sessió automàtica és vàlida mentre un usuari no visita els fòrums. Introdueix un zero per tal que la clau no caduqui.';

// Control de cerques massives - afegit a la versió 2.0.20
$lang['Search_Flood_Interval'] = 'Interval contra cerques massives';
$lang['Search_Flood_Interval_explain'] = 'Temps en segons que ha d\'esperar un usuari entre dues peticions de cerca'; 
...
$lang['smiley_import_success'] = 'El Paquet de Smileys s\'ha importat correctament!';
...
$lang['Confirm_delete_smiley'] = 'Estàs segur que vols esborrar aquest Smiley?';
...
$lang['Confirm_delete_word'] = 'Estàs segur que vols esborrar aquest censor de paraules?';
...
$lang['Confirm_delete_rank'] = 'Estàs segur que vols esborrar aquest rang?';
...
$lang['Create_theme_explain'] = 'Utilitza el següent formulari per crear un tema nou per a una plantilla seleccionada. Quan introdueixis els colors (per als quals hauries d\'utilitzar notació hexadecimal) no has d\'incloure el # inicial, p.e. CCCCCC es vàlid mentre que #CCCCCC no ho és';
...
$lang['Stylesheet_explain'] = 'Nom d\'arxiu del full d\'estil CSS utilitzat en aquest tema.';
$lang['Background_image'] = 'Imatge de Fons';
$lang['Background_color'] = 'Color de Fons';
$lang['Theme_name'] = 'Nom del Tema';
...
//
// Comprovació de Versió
//
$lang['Version_up_to_date'] = 'La teva instal·lació està al dia, no hi ha cap actualització disponible per a la teva versió de phpBB.';
$lang['Version_not_up_to_date'] = 'Sembla que la teva instal·lació <b>no</b> està al dia. Hi ha actualitzacions disponibles per a la teva versió de phpBB, si us plau visita <a href="http://www.phpbb.com/downloads.php" target="_new">http://www.phpbb.com/downloads.php</a> per tal d\'obtenir la darrera versió.';
$lang['Latest_version_info'] = 'La darrera versió disponible és <b>phpBB %s</b>.';
$lang['Current_version_info'] = 'La teva versió és <b>phpBB %s</b>.';
$lang['Connect_socket_error'] = 'No ha estat possible establir una connexió amb el servidor de phpBB, l\'error obtingut és:<br />%s';
$lang['Socket_functions_disabled'] = 'No ha estat possible utilitzar les funcions de socket.';
$lang['Mailing_list_subscribe_reminder'] = 'Si vols obtenir l\'informació més recent sobre actualitzacions de phpBB <a href="http://www.phpbb.com/support/" target="_new">subscriu-te a la nostra llista de correu</a>.';
$lang['Version_information'] = 'Informació de la versió';


//
// Configuració dels intents d'inici de sessió
//
$lang['Max_login_attempts'] = 'Intents d\'inici de sessió permesos';
$lang['Max_login_attempts_explain'] = 'Quants cops es pot intentar iniciar una sessió sense bloquejar l\'usuari.';
$lang['Login_reset_time'] = 'Temps de bloqueig d\'inici de sessió';
$lang['Login_reset_time_explain'] = 'Temps en minuts que un usuari ha d\'esperar abans que se li permeti iniciar una sessió després d\'haver sobrepassat el nombre màxim d\'intents.';

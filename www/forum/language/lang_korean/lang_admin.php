...
$lang['Smilies_path_explain'] = 'phpBB 루트 디렉토리 하의 경로, 즉, images/smiles';
...
$lang['Avatar_storage_path_explain'] = 'phpBB 루트 디렉토리 하의 경로, 즉, images/avatars';
...
$lang['Cookie_settings_explain'] = '다음의 자세한 내용들은 쿠키가 어떻게 사용자 브라우저로 보내지는 가를 정의합니다. 대부분의 경우에 있어서 디폴트의 쿠키 설정치들이 적당하지만, 만약 변경을 하고자 한다면 주의를 요하며 잘못된 설정은 사용자로 하여금 로그인하지 못하게 할 수 있습니다';
...
$lang['Visual_confirm_explain'] = '사용자 등록할 때 이미지에 그려진 코드를 반드시 등록해야 합니다.';
...
// Version Check
//
$lang['Version_up_to_date'] = '지금 설치된 버전은 최신 버전으로 업데이트가 필요하지 않습니다.';
$lang['Version_not_up_to_date'] = '지금 사용중인 phpBB는 <b>최신버전이 아닌 것 같습니다.</b> phpBB의 업데이트가 나왔습니다, 새 버전은 받기 위해 <a href="http://www.phpbb.com/downloads.php" target="_new">http://www.phpbb.com/downloads.php</a>를 방문하시기 바랍니다.';
$lang['Latest_version_info'] = '최신 버전은 <b>phpBB %s</b>입니다..';
$lang['Current_version_info'] = '<b>phpBB %s</b>를 사용중입니다.';
$lang['Connect_socket_error'] = 'phpBB서버와 연결할 수 없습니다., 보고된 오류:<br />%s';
$lang['Socket_functions_disabled'] = '소켓 관련 함수를 사용할 수 없습니다.';
$lang['Mailing_list_subscribe_reminder'] = 'phpBB의 최신 정보를 얻고자 하시면 <a href="http://www.phpbb.com/support/" target="_new">메일링 리스트</a>에 가입하십시오.';

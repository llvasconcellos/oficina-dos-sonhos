...
//
 $faq[] = array("--","소개");
$faq[] = array("BBCode란 무엇인가", "BBCode는 HTML의 특별한 구현이다. 게시판상에 글을 올릴때 BBCode를 사용할수 있는지는 운영자가 결정한다. 또한 글 양식에서 각 글에 대하여 개별적으로 BBCode를 억제할 수 있다. BBCode는 스타일에 있어 HTML와 흡사하여, 태그는 &lt; 와 &gt; 대신에 대괄호 [ 와 ] 안에 들어가며, 어떤것을 어떻게 표시할 것인지를 강력하게 제어한다. 사용하는 템플레이트에 따라 글 양식의 메시지 영역위에 있는 클릭이 가능한 인터페이스로 BBCode를 글에 추가하는 것이 더 수월해 졌다는 것을 알게 될 것이다. 다음의 유용한 설명서를 보도록 하자."); 

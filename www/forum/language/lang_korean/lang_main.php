...
$lang['Too_many_registers'] = '너무 많은 등록시도를 하였습니다. 잠시후에 다시 시도하여 주십시오.';
...
//
$lang['Confirm_code_wrong'] = '입력한 확인코드가 올바르지 않습니다.The confirmation code you entered was incorrect';
$lang['Too_many_registers'] = '이 세션에서 시도한 등록횟수가 초과되었습니다. 잠시후에 다시 시도하여 주십시오.';
$lang['Confirm_code_impaired'] = 'If you are visually impaired or cannot otherwise read this code %s관리자%s와 상담하십시오';
$lang['Confirm_code'] = '확인코드';
$lang['Confirm_code_explain'] = '보신 그대로 입력하십시오. 이 코드는 대소문자를 구별하며 0도 유효합니다.';

 ...
 *
 *     $Id: lang_admin.php,v 1.4 2006/05/20 14:07:48 virtuality Exp $
 *
 ****************************************************************************/
...
$lang['Admin_email'] = "E-postadress till administratörskontot";
...
$lang['Allow_autologin_explain'] = 'Bestämmer om användarna ska kunna välja att loggas in automatiskt i fortsättningen eller ej.';
$lang['Autologin_time'] = 'Antal dagar automatisk inloggnignsnyckel gäller';
$lang['Autologin_time_explain'] = 'Hur länge en autologinnyckel ska gälla om användaren inte besöker forumet. Sätt till noll om nyckeln aldrig ska sluta gälla.';

// Search Flood Control - added 2.0.20
$lang['Search_Flood_Interval'] = 'Search Flood Interval';
$lang['Search_Flood_Interval_explain'] = 'Antal sekunder en användare måste vänta mellan sökningar'; 
...
$lang['Confirm_delete_smiley'] = 'Är du säker på att du vill ta bort denna smiley?';
...
$lang['Click_return_wordadmin'] = "Klicka %shär%s för att återgå till censurering av ord";
  
$lang['Confirm_delete_word'] = 'Är du säker på att du vill ta bort denna censurering?';
...
$lang['Click_return_rankadmin'] = "Klicka %shär%s för att återgå till Rankadministration";

$lang['Confirm_delete_rank'] = 'Är du säker på att du vill ta bort denna rank?';
...
$lang['Stylesheet_explain'] = 'Filnamn för CSS stylesheet att använda för detta tema.';
...
// Install Process
//
$lang['Welcome_install'] = "Välkommen till installationen av phpBB 2";
$lang['Initial_config'] = "Grundläggande konfiguration";
$lang['DB_config'] = "Databaskonfiguration";
$lang['Admin_config'] = "Administratörkonfiguration";
$lang['continue_upgrade'] = "När du har laddat ner din config-fil till din dator kan du tryckka på \"Fortsätt uppgraderingen\" nedan för att fortsätta uppgraderingsprocessen. Vänta med att ladda upp config-filen tills uppgraderingsprocessen är färdig.";
$lang['upgrade_submit'] = "Fortsätt uppgraderingen";
...
$lang['Re_install'] = "Din föregående installation är fortfarande aktiv. <br /><br />Om du vill ominstallera phpBB 2 klicka på Ja-knappen nedan. Var medveten om att detta förstör all befintlig data, ingen säkerhetskopiering kommer att ske! Administratörs användarnamnet och lösenord som du har använt för att logga in till forumet kommer att återskapas efter ominstallation, inga andra inställningar kommer att behållas. <br /><br />Tänk igenom detta noga innan du trycker på Ja!";

$lang['Inst_Step_0'] = "Tack för att du valt phpBB 2. För att slutföra installationen, fyll i informationen som efterfrågas nedan. Kom ihåg att databasen som du tänker installera till redan måste finnas. Om du installerar till en databas som använder ODBC, t.ex. MS Access, så måste du först skapa ett DSN som pekar mot den innan du går vidare.";

$lang['Start_Install'] = "Starta installationen";
$lang['Finish_Install'] = "Slutför installationen";
...
$lang['Admin_Username'] = "Användarnamn till administratörskontot";
$lang['Admin_Password'] = "Lösenord till administratörskontot";
$lang['Admin_Password_confirm'] = "Lösenord till administratörskontot [ bekräfta ]";

$lang['Inst_Step_2'] = "Ditt administratörskonto har skapats. Nu är grundinstallationen klar. Du kommer nu att skickas till en sida där du har möjlighet att administrera din nya installation. Var god kontrollera dina inställningar och gör nödvändiga ändringar. Tack för att du valt phpBB 2.";

$lang['Unwriteable_config'] = "Din config-fil är inte skrivbar för tillfället. En kopia av config-filen kommer att skickas till dig när du klickar på kanppen nedan. Du måste sedan ladda upp denna fil till samma katalog som phpBB 2. När detta är gjort så loggar du in med ditt administratöranvändarnamn och lösenord (som du angav på förra sidan) och besöka administratörspanelen (en länk kommer att finns längst ner på varje sida när du väl har logga in) för att kontrollera den allmänna konfigurationen. Tack för att du valt phpBB 2.";
$lang['Download_config'] = "Ladda ner konfiguration";

$lang['ftp_choose'] = "Välj nedladdningsmetod";
$lang['ftp_option'] = "<br />Eftersom FTP-tillägg är aktiverat i denna version av PHP ges du också möjlighet att försöka ladda upp config-filen via FTP helt automatiskt.";
$lang['ftp_instructs'] = "Du har valt att ladda upp filen via FTP helt automatiskt. Ange informationen som saknas nedan. Notera att FTP sökvägen ska vara exakt samma sökväg till din phpBB 2 installation som du skulle använda om du använder en vanlig FTP-klient.";
...
$lang['NoFTP_config'] = "Försöket att ladda upp config-filen via FTP misslyckades. Ladda hem filen och ladda upp den manuellt.";
...
$lang['Install_No_Ext'] = "PHP-konfigurationen på din server stödjer inte den databastyp du har valt";

$lang['Install_No_PCRE'] = "phpBB2 kräver \"Perl-Compatible Regular Expressions Module for php\" vilket din PHP-konfiguration inte verkar ha!";

// 
// Version Check 
// 
$lang['Version_up_to_date'] = 'Din installation är av den senaste versionen, inga nya uppgraderingar finns tillgängliga för din version av phpBB.'; 
$lang['Version_not_up_to_date'] = 'Din installation är <b>inte</b> av 
den senaste versionen. Uppgraderingar finns tillgängliga på <a href="http://www.phpbb.com/downloads.php" target="_new">http://www.phpbb.com/downloads.php</a>.'; 
$lang['Latest_version_info'] = 'Den senaste versionen är <b>phpBB %s</b>. '; 
$lang['Current_version_info'] = 'Du använder <b>phpBB %s</b>.'; 
$lang['Connect_socket_error'] = 'Kunde inte ansluta till phpBB.com... Felmeddelande:<br />%s'; 
$lang['Socket_functions_disabled'] = 'Kunde inte använda socketfunktioner.'; 
$lang['Mailing_list_subscribe_reminder'] = 'För att få information om nya versioner och uppgraderingar av phpBB, var vänlig <a href="http://www.phpbb.com/support/" target="_new">registrera dig på vår epostlista</a>.</a>.'; 
$lang['Version_information'] = 'Versionsinformation';

//
// Login attempts configuration
//
$lang['Max_login_attempts'] = 'Max. ogiltiga inloggingsförsök'; 
$lang['Max_login_attempts_explain'] = 'Antalet inloggningsförsök man får göra innan kontot låses.'; 
$lang['Login_reset_time'] = 'Kontolåsningstid'; 
$lang['Login_reset_time_explain'] = 'Antalet minuter en användare måste vänta innan han får försöka logga in igen efter att ha överskridit det tillåtna antalet inloggningsförsök.';

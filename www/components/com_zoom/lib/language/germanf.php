...
define("_ZOOM_CATSMGR_DESCR","Erstelle neue Alben f&uuml;r Ihre neuen Medien, erstelle und l&ouml;sche sie hier im Album-Manager.");
...
define("_ZOOM_ADMIN_CREATE_DESCR","Erstelle die ben&ouml;tigten Datenbanktabellen, dann können Sie beginnen, das Album zu benutzen.");
...
define("_ZOOM_A_MESS_NOT_SHURE","* Wenn Sie nicht sicher sind, benutzen Sie default \"auto\" ");
...
define("_ZOOM_A_MESS_NOJAVA","Wenn Sie hier eine graue Box sehen oder Probleme beim hochladen haben, <br /> k&ouml;nnte es sein, dass Sie eine neuere Java run-time installieren mu&szlig;en. Gehen Sie auf <a href=\"http://www.java.com\" target=\"_blank\">Java.com</a> <br /> und laden Sie die neueste Version herunter.");
...
define("_ZOOM_SETTINGS_PRIV_DESCR","Sie haben die M&ouml;glichkeit, die Privilegien jeder in Joomla! bekannten Gruppe zu &auml;ndern und dadurch auch die Privilegien von
    ...
    Was sie nun aber tats&auml;chlich machen d&uuml;rfen h&auml;ngt allein von ihnen ab.");
...
define("_ZOOM_UPLOAD_STEP1","1. W&auml;hlen Sie die Anzahl der Dateien, die Sie hochladen wollen: ");
define("_ZOOM_UPLOAD_STEP2","2. W&auml;hlen Sie das Album, in das Sie die Dateien ablegen wollen: ");
define("_ZOOM_UPLOAD_STEP3","3. Benutzen Sie den Durchsuchen-Knopf, um Medien von ihrem Computer auszuw&auml;hlen");
define("_ZOOM_SCAN_STEP1","Step 1: W&auml;hlen Sie einen Ort, der nach Medien durchsucht werden soll...");
define("_ZOOM_SCAN_STEP2","Step 2: W&auml;hlen Sie die Medien aus, die Sie hochladen wollen...");
define("_ZOOM_SCAN_STEP3","Step 3: zOOm verarbeitet die Medien, die Sie ausgew&auml;hlt haben...");
...
define("_ZOOM_CONFIRM_DELMEDIUM","Sie sind dabei, dieses Media komplett zu enfernen!\\nWollen Sie wirklich fortfahren?");
...
define("_ZOOM_INFO_CHECKCAT","Bitte w&auml;hlen Sie erst ein Album, bevor Sie den Hochladen-Knopf benutzen!");
...
define("_ZOOM_ALERT_COMMENTERROR","Sie haben dieses Media bereits kommentiert!");
define("_ZOOM_ALERT_VOTE_OK","Ihre Bewertung wurde gespeichert! Dankesch&ouml;n!");
define("_ZOOM_ALERT_VOTE_ERROR","Sie haben dieses Media bereits bewertet!");
...
define("_ZOOM_LIGHTBOX_NOZIP","Sie haben schon eine ZIP-Datei in ihrer Lightbox erstellt!");
define("_ZOOM_LIGHTBOX_PARSEZIP","F&uuml;ge Medien aus Album ein...");
define("_ZOOM_LIGHTBOX_DOZIP","Erstelle ZIP-Datei...");
define("_ZOOM_LIGHTBOX_DLHERE","Sie können nun die Lightbox herunterladen");
define("_ZOOM_LIGHTBOX_PLSUCCESS","Playliste erfolgreich erstellt! Sie mu&szlig;en das Playerfenster jetzt aktualisieren.");
define("_ZOOM_LIGHTBOX_PLERROR","Fehler beim erstellen der Playliste.");
define("_ZOOM_LIGHTBOX_NOAUDIO","Sie mu&szlig;en erst Audiodateien in ihre Lightbox legen!");
define("_ZOOM_LIGHTBOX_NOITEMS","Ihre Lightbox scheint leer zu sein.");
...
define("_ZOOM_ECARD_YOUREMAIL","Ihre E-Mail Addresse");
define("_ZOOM_ECARD_FRIENDSNAME","Name ihres Freundes");
define("_ZOOM_ECARD_FRIENDSEMAIL","E-Mail Addresse ihres Freundes");
define("_ZOOM_ECARD_MESSAGE","Nachricht");
define("_ZOOM_ECARD_SENDCARD","Sende E-Card");
define("_ZOOM_ECARD_SUCCESS","Ihre E-Card wurde erfolgreich versandt.");
...
define("_ZOOM_ECARD_MSG2","Klicken Sie auf den Link darunter, um ihre pers&ouml;nliche E-Card zu sehen");
...
define ('_ZOOM_INSTALL_MESS1','zOOm Media Gallery wurde erfolgreich installiert.<br>Sie können nun ihre Fotos und Alben ver&ouml;ffentlichen!');
define ('_ZOOM_INSTALL_MESS2','Anmerkung: Das erste, was Sie jetzt tun sollten ist, in das Componenten Men&uuml; zu wechseln.<br>Suche nach dem Eintrag "zOOm Media Gallery Admin", anklicken und in die <br>Einstellungen wechseln.');
define ('_ZOOM_INSTALL_MESS3','Hier kann man alle Parameter f&uuml;r zOOm &auml;ndern.');
...
define ('_ZOOM_INSTALL_MESS_FAIL3','Wenn Sie diese Verzeichnisse eingerichtet heben, gehen Sie zu <br /> "Components -> zOOm Media Gallery" und &auml;ndern die Einstellungen.');
?>

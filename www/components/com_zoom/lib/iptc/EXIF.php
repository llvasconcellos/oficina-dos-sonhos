...
function interpret_IFD( $IFD_array, $filename )
{
        ...
        $output_str = "<table class=\"EXIF_Table\" border=\"0\" cellspacing=\"0\" cellspadding=\"3\" width=\"70%\">\n";
        ...
        foreach( $IFD_array as $Tag_ID => $Exif_Tag )
        {
                ...
                else
                {
                             ...
                             ( $Tag_ID == 513 ) )
                        {
                                ...
                                $output_str .= "<tr class=\"EXIF_Table_Row\"><td class=\"EXIF_Caption_Cell\">" . $Exif_Tag['Tag Name'] . "</td><td class=\"EXIF_Value_Cell\"><a class=\"EXIF_First_IFD_Thumb_Link\" href=\"$mosConfig_live_site/components/com_zoom/classes/iptc/get_exif_thumb.php?filename=$filename\"><img class=\"EXIF_First_IFD_Thumb\" src=\"$mosConfig_live_site/components/com_zoom/classes/iptc/get_exif_thumb.php?filename=$filename\"></a></td></tr>\n";
                        }

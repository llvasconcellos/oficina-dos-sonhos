...
function Interpret_intrinsic_values_to_HTML( $values )
{
        ...
        if ( $values != FALSE )
        {
                ...
                // Create Table
                $OutputStr .= "<table class=\"JPEG_Intrinsic_Table\" border=\"0\" cellspacing=\"0\" cellpadding=\"3\">\n";
...
function Generate_JPEG_APP_Segment_HTML( $jpeg_header_data )
{
        ...
        // Create table
        $output .= "<table class=\"JPEG_APP_Segments_Table\" border=\"0\" cellspacing=\"0\" cellpadding=\"3\">\n";

<?php
// $Id: germanf.php,v 1.10 2004/10/05 20:23:01 mleinmueller Exp $
//Events//
/**
* Content code
...
DEFINE("_CAL_LANG_ACT_ADDED", "Danke für Ihren Beitrag - wir werden ihn schnell bearbeiten!"); //NO ACCENT !!
...
DEFINE("_CAL_LANG_REP_NOEVENTSELECTED", "Bitte wählen Sie zuerst einen Temin aus");
...
DEFINE("_CAL_LANG_EVENT_CHOOSE_CATEG", "Bitte wählen sie eine Kategorie aus");
DEFINE("_CAL_LANG_EVENT_ACTIVITY", "Aktivität");
DEFINE("_CAL_LANG_EVENT_URLMAIL_INFO", "Für Links oder E-Mail-Adressen, benutzen Sie bitte <u>http://www.mysite.com</u> oder <u>mailto:my@mail.com</u>");
...
DEFINE("_CAL_LANG_E_WARNWEEKS", "Bitte wählen Sie eine Woche.");
DEFINE("_CAL_LANG_E_WARNDAYS", "Bitte wählen Sie einen Tag.");
...
DEFINE("_CAL_LANG_WARNACTIVITY", "Eine Beschreibung der\\Aktivität muss eingegeben werden.");
	...
	$com_events_form_help_color = <<<END
        <tr>
            ...
            <td>Wählen Sie die Hintergrundfarbe, die in der Monatsansicht des Kalendars verwendet werden soll. 
            Sofern Sie die Kategorie-Auswahlbox aktivieren, wird die vom Administrator vorgegebene Farbe verwendet und der 'Farbpicker'-Knopf inaktiv gesetzt.
            </td>
        </tr>
END;
	...
	$com_events_form_help = <<<END
    	<tr>
          ...
          <td>Wählen Sie das Start- und Endedatum Ihres Ereignisses aus.</td>
        </tr>
    	<tr>
          <td align="left" valign="top"><b>Zeit</b></td>
          <td>Wählen Sie die Zeitdauer Ihres Ereignisses. Das Format ist <span style='color:blue;font-weight:bold;'>hh:mm</span>.<br/> 
          Die Zeit kann entweder im 12 oder 24 Stundenformat eingegeben werden.<br/><br/>
          <b><i><span style='color:red;'>Neu:</span></i></b> Bitte beachten Sie den Spezialfall für ein <span style='color:red;font-weight:bold;'>eintägiges Ereignis über Mitternacht</span>.  
  	...
  	<tr>
	    	...
	    	<table width="100%" border="0" cellspacing="2">
                ...
                <td align="left" valign="top" class="frm_td_bydays">
                  <font color="#000000">Wählen Sie diese Option für einen sich nicht wiederholendes 
